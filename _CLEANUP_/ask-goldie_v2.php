...
if (isset($_GET['new']) && $_GET['new'] == 1) {
    ...
    header('Location: /ask-goldie_v2');
    exit;
}

// Load conversation history from session for now
// (Database persistence would require adding Database class to $addClasses)
$conversationHistory = [];
    ...
    <div class="ask-goldie-container">
        ...
        <div class="conversation-panel">
            <div class="conversation-info">
                <div>
                    <h3 class="h5 mb-0">Your Conversation with Goldie</h3>
                    <small class="text-muted">
                        <?php if (!empty($current_user_data['user_id'])): ?>
                            Saved to your account
                        <?php else: ?>
                            Session ID: <?php echo substr($conversationId, 0, 16); ?>...
                        <?php endif; ?>
                    </small>
                </div>
                <a href="/ask-goldie_v2?new=1" class="btn btn-sm btn-outline-primary">
                    <i class="bi bi-plus-circle me-1"></i>New Conversation
                </a>
            </div>
            <div class="conversation-history">
                <?php foreach ($conversationHistory as $item): ?>
                <div class="history-item">
                    ...
                    <div class="history-bubble goldie-bubble">
        ...
        <div class="chat-interface">
            ...
            <!-- Question Form -->
            <form method="POST" action="/ask-goldie_v2" class="question-form">
