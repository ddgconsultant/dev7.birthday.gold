...
// Initialize conversation history (max 10 exchanges)
if (!isset($_SESSION['ask_goldie_history'])) {
    $_SESSION['ask_goldie_history'] = [];
}

// Option to clear history
if (isset($_GET['clear']) && $_GET['clear'] == 1) {
    $_SESSION['ask_goldie_history'] = [];
    header('Location: /ask-goldie_v1');
    exit;
}
...
Birthday Gold is a service that automatically enrolls users in birthday reward programs from various businesses.";
                    ...
                    if (count($_SESSION['ask_goldie_history']) > 10) {
                        array_shift($_SESSION['ask_goldie_history']);
                    }
...
<div class="container py-5">
    <div class="ask-goldie-container">
        ...
        <!-- Conversation History -->
        <?php if (!empty($_SESSION['ask_goldie_history'])): ?>
        <div class="d-flex justify-content-between align-items-center mb-3">
            <h3 class="h5 mb-0">Conversation History</h3>
            <a href="/ask-goldie_v1?clear=1" class="btn btn-sm btn-outline-secondary">
                <i class="bi bi-trash me-1"></i>Clear History
            </a>
        </div>
        <div class="conversation-history">
            <?php foreach ($_SESSION['ask_goldie_history'] as $item): ?>
            <div class="history-item">
                <div class="history-label">You asked:</div>
                <div class="history-question">
                    <?php echo htmlspecialchars($item['question']); ?>
                </div>
                <div class="history-label mt-2">Goldie answered:</div>
        ...
        <div class="chat-interface">
            ...
            <!-- Question Form -->
            <form method="POST" action="/ask-goldie_v1" class="question-form">
