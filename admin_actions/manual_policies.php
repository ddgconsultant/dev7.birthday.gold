...
if ($policy['name']=='terms') {$urlx['terms']=$policy['description']; $urlx['count']++;}
if ($policy['name']=='privacy') {$urlx['privacy']=$policy['description']; $urlx['count']++;}
...
if ($urlx['count']>=2) {
    ...
    $linkColor='text-white';
        ...
        echo '<div class="accordion-item">
                ...
                <div id="collapse'.$company_id.'" class="accordion-collapse collapse" aria-labelledby="heading'.$company_id.'" data-bs-parent="#companyAccordion">
