...
if (!$existing) {
    ...
    $insert_sql = "INSERT INTO bg_company_attributes 
                  ...
                  VALUES 
                  (:company_id, 'onboarding_progress', 'abo_grabage', 'pending', 'active', NOW())";
    $database->query($insert_sql, ['company_id' => $company_id]);
    echo "Created age progress record for company $company_id\n";
} else {
    // Update to pending
    ...
    echo "Updated age progress to pending for company $company_id\n";
}