<?php
/**
 * Marketing Newsletter Queue Scheduler V2
 * Runs every 5 minutes to check for scheduled campaigns and populate the notification queue
 * This job creates notification entries that will be processed by the sender job
 */
...
echo date('Y-m-d H:i:s') . " - Starting newsletter queue scheduler V2\n";
