-- =====================================================
-- Product Features Population SQL Script
-- =====================================================
-- This script adds feature metadata to bg_product_features
-- for Gold and Life plans.
--
-- Run this with:
-- mysql -h "71.33.250.235" -u "claudecode" -p "birthday_gold_www" < insert_product_features.sql
-- =====================================================

-- Step 1: Clear existing feature metadata entries
DELETE FROM bg_product_features
