...
if ($show_learn_more) {
    ...
    <div class="container-fluid pb-5" style="max-width: 1200px;">
        <div class="text-end mb-3">
            <a href="/recommend-business" class="btn btn-primary">Submit a Recommendation</a>
        </div>
        <div class="bg-white rounded-3 shadow-soft overflow-hidden">
            <div class="p-5">
                ...
                <div class="text-center mt-4">
                    <a href="/recommend-business" class="btn btn-primary btn-lg" style="border-radius: 50px;">
    ...
    <div class="container-fluid hero-grid align-items-center px-lg-4 py-3" style="max-width: 1200px; margin: 0 auto;">
        ...
        <div class="w-100" style="max-width: 480px; margin: 0 auto;">
            <div class="text-end mb-3">
                <a href="/recommend-business?learnmore" class="btn btn-outline-secondary btn-sm">Learn More</a>
            </div>
