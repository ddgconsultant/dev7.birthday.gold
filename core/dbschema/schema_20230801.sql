/*
 ...
 Source Server         : DDGDATA8-71.33.250.235 _ WAN
 Source Server Type    : MySQL
 Source Server Version : 80031
 Source Host           : 71.33.250.235:3306
...
-- ----------------------------
-- Table structure for bg_apitracking
-- ----------------------------
DROP TABLE IF EXISTS `bg_apitracking`;
CREATE TABLE `bg_apitracking`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 6365 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci ROW_FORMAT = Dynamic;
...
CREATE TABLE `bg_companies`  (
  ...
  `create_dt` timestamp NULL DEFAULT CURRENT_TIMESTAMP,
  `modify_dt` timestamp NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  `company_status` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT 'active',
  `status` varchar(16) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL DEFAULT 'active',
...
-- ----------------------------
-- Table structure for bg_form_field_mappings_copy1
-- ----------------------------
DROP TABLE IF EXISTS `bg_form_field_mappings_copy1`;
CREATE TABLE `bg_form_field_mappings_copy1`  (
  `mapping_id` bigint UNSIGNED NOT NULL AUTO_INCREMENT,
  `company_id` bigint UNSIGNED NULL DEFAULT NULL,
  `location_id` bigint UNSIGNED NULL DEFAULT NULL,
  `version` int NULL DEFAULT 1,
  ...
  INDEX `company_id`(`company_id`) USING BTREE,
  INDEX `location_id`(`location_id`) USING BTREE,
  CONSTRAINT `bg_form_field_mappings_copy1_ibfk_1` FOREIGN KEY (`company_id`) REFERENCES `bg_companies` (`company_id`) ON DELETE RESTRICT ON UPDATE RESTRICT,
  CONSTRAINT `bg_form_field_mappings_copy1_ibfk_2` FOREIGN KEY (`location_id`) REFERENCES `bg_company_locations` (`location_id`) ON DELETE RESTRICT ON UPDATE RESTRICT
) ENGINE = InnoDB AUTO_INCREMENT = 3419 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci ROW_FORMAT = Dynamic;
...
-- ----------------------------
-- Table structure for bg_lockout
-- ----------------------------
DROP TABLE IF EXISTS `bg_lockout`;
CREATE TABLE `bg_lockout`  (
  `id` bigint NOT NULL AUTO_INCREMENT,
  `ip` varchar(62) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL,
  `type` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL,
  ...
  `status` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT 'active',
  PRIMARY KEY (`id`) USING BTREE,
  INDEX `idx0`(`ip`, `start_dt`, `expire_dt`) USING BTREE
...
-- ----------------------------
-- Table structure for bg_plans
-- ----------------------------
DROP TABLE IF EXISTS `bg_plans`;
CREATE TABLE `bg_plans`  (
  `id` int NOT NULL AUTO_INCREMENT,
...
-- ----------------------------
-- Table structure for bg_sessions
-- ----------------------------
DROP TABLE IF EXISTS `bg_sessions`;
CREATE TABLE `bg_sessions`  (
  `id` int NOT NULL AUTO_INCREMENT,
  `user_id` int NULL DEFAULT NULL,
  `session_id` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL,
  `type` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT 'admin',
  `create_dt` datetime NULL DEFAULT NULL,
  `expire_dt` datetime NULL DEFAULT NULL,
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci ROW_FORMAT = Dynamic;
...
CREATE TABLE `bg_sessiontracking`  (
  ...
  `server_data` text CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL,
  PRIMARY KEY (`id`) USING BTREE,
  INDEX `idx0`(`sessionid`, `create_dt`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 8432 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci ROW_FORMAT = Dynamic;

-- ----------------------------
-- Table structure for bg_subscriptions
-- ----------------------------
DROP TABLE IF EXISTS `bg_subscriptions`;
CREATE TABLE `bg_subscriptions`  (
  `id` bigint NOT NULL AUTO_INCREMENT,
...
-- ----------------------------
-- Table structure for bg_user_attributes
-- ----------------------------
DROP TABLE IF EXISTS `bg_user_attributes`;
CREATE TABLE `bg_user_attributes`  (
  `attribute_id` bigint NOT NULL AUTO_INCREMENT,
  `user_id` bigint NULL DEFAULT NULL,
  `type` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL,
  `name` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL,
  ...
  `end_dt` datetime NULL DEFAULT NULL,
  PRIMARY KEY (`attribute_id`) USING BTREE,
  INDEX `idx0`(`user_id`, `name`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 30333 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci ROW_FORMAT = Dynamic;
...
-- ----------------------------
-- Table structure for bg_user_profiledata
-- ----------------------------
DROP TABLE IF EXISTS `bg_user_profiledata`;
CREATE TABLE `bg_user_profiledata`  (
  ...
  `agree_terms` varchar(5) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT 'true',
  `agree_email` varchar(5) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT 'true',
  `agree_text` varchar(5) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT 'true',
  `allergy_gluten` varchar(5) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL,
  `allergy_sugar` varchar(5) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL,
  `allergy_nuts` varchar(5) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL,
  `allergy_dairy` varchar(5) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL,
  `diet_vegan` varchar(5) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL,
  `diet_kosher` varchar(5) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL,
  `diet_pescatarian` varchar(5) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL,
  `diet_keto` varchar(5) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL,
  `diet_paleo` varchar(5) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL,
  `diet_vegetarian` varchar(5) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL,
  PRIMARY KEY (`user_id`) USING BTREE,
  INDEX `idx0`(`user_id`, `username`, `email`) USING BTREE
...
CREATE TABLE `bg_users`  (
  ...
  `state` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL,
  `zip_code` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL,
  `country` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT 'United States',
  `phone_number` varchar(30) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL,
  `birthdate` date NULL DEFAULT NULL,
  `create_dt` timestamp NULL DEFAULT CURRENT_TIMESTAMP,
  `modify_dt` timestamp NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  ...
  `avatar` varchar(500) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL,
  `profile_username` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL,
  `profile_email` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL,
  `profile_password` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL,
  `profile_title` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL,
  `profile_first_name` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL,
  `profile_middle_name` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL,
  `profile_last_name` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL,
  `profile_mailing_address` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL,
  `profile_city` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL,
  `profile_state` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL,
  `profile_zip_code` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL,
  `profile_country` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT 'United States',
  `profile_phone_number` varchar(30) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL,
  `profile_gender` varchar(10) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL,
  `profile_agree_terms` varchar(5) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT 'true',
  `profile_agree_email` varchar(5) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT 'true',
  `profile_agree_text` varchar(5) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT 'true',
  `profile_allergy_gluten` varchar(5) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL,
  `profile_allergy_sugar` varchar(5) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL,
  `profile_allergy_nuts` varchar(5) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL,
  `profile_allergy_dairy` varchar(5) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL,
  `profile_diet_vegan` varchar(5) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL,
  `profile_diet_kosher` varchar(5) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL,
  `profile_diet_pescatarian` varchar(5) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL,
  `profile_diet_keto` varchar(5) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL,
  `profile_diet_paleo` varchar(5) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL,
  `profile_diet_vegetarian` varchar(5) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL,
  `profile_military` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL,
  `profile_educator` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL,
  `profile_firstresponder` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL,
  PRIMARY KEY (`user_id`) USING BTREE,
  INDEX `idx0`(`user_id`, `username`, `email`) USING BTREE,
  INDEX `idx1`(`create_dt`, `status`) USING BTREE
...
CREATE TABLE `coming_soon_emails`  (
  ...
  `status` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci NULL DEFAULT 'active',
  `regcode` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci NULL DEFAULT NULL,
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = MyISAM AUTO_INCREMENT = 34 CHARACTER SET = utf8mb3 COLLATE = utf8mb3_unicode_ci ROW_FORMAT = Dynamic;
...
-- ----------------------------
-- Table structure for ds_testip
-- ----------------------------
DROP TABLE IF EXISTS `ds_testip`;
CREATE TABLE `ds_testip`  (
  `recordid` int UNSIGNED NOT NULL AUTO_INCREMENT,
  `ip` varchar(15) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL,
  `modifydt` timestamp NULL DEFAULT NULL ON UPDATE CURRENT_TIMESTAMP,
  `status_code` varchar(50) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT 'A',
  `flags` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL,
  `history` text CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL,
  PRIMARY KEY (`recordid`) USING BTREE,
  INDEX `indx1`(`ip`, `status_code`) USING BTREE
...
-- ----------------------------
-- Triggers structure for table ds_testip
-- ----------------------------
DROP TRIGGER IF EXISTS `_sysaudit_ds_testip_insert`;
delimiter ;;
CREATE TRIGGER `_sysaudit_ds_testip_insert` BEFORE INSERT ON `ds_testip` FOR EACH ROW BEGIN   INSERT INTO `shepherdsheartministry_com_auditdb`.`_sysaudit_ds_testip` values(now(), "inserted",  user(), `NEW`.`recordid`,`NEW`.`ip`,`NEW`.`modifydt`,`NEW`.`status_code`,`NEW`.`flags`,`NEW`.`history`); END
;;
delimiter ;
...
-- Triggers structure for table ds_testip
-- ----------------------------
DROP TRIGGER IF EXISTS `_sysaudit_ds_testip_update`;
delimiter ;;
CREATE TRIGGER `_sysaudit_ds_testip_update` BEFORE UPDATE ON `ds_testip` FOR EACH ROW BEGIN  INSERT INTO `shepherdsheartministry_com_auditdb`.`_sysaudit_ds_testip` values    (now(), "updated_from",  user(), `OLD`.`recordid`,`OLD`.`ip`,`OLD`.`modifydt`,`OLD`.`status_code`,`OLD`.`flags`,`OLD`.`history`),   (now(), "updated_to",  user(), `NEW`.`recordid`,`NEW`.`ip`,`NEW`.`modifydt`,`NEW`.`status_code`,`NEW`.`flags`,`NEW`.`history`); END
;;
delimiter ;
...
-- Triggers structure for table ds_testip
-- ----------------------------
DROP TRIGGER IF EXISTS `_sysaudit_ds_testip_delete`;
delimiter ;;
CREATE TRIGGER `_sysaudit_ds_testip_delete` BEFORE DELETE ON `ds_testip` FOR EACH ROW BEGIN   INSERT INTO `shepherdsheartministry_com_auditdb`.`_sysaudit_ds_testip` values(now(), "deleted",  user(), `OLD`.`recordid`,`OLD`.`ip`,`OLD`.`modifydt`,`OLD`.`status_code`,`OLD`.`flags`,`OLD`.`history`); END
;;
delimiter ;
