...
<div class="company-details col-10 ms-0 ps-0">
<div class="card-body d-flex flex-column">
'.$setuplink.'<span class="product-name h4">' . $item_company['company_name'] . '</span>
<p class="card-text business-descriptionx mb-0 pb-0">' . $item_company['description'] . '</p>

<p class="d-inline-flex gap-1 pt-0 mt-0">
  <button class="btn btn-sm btn-outline-secondary  p-0 m-0 px-1" type="button" data-bs-toggle="collapse" data-bs-target="#collapse'.$item_company['company_id'].'" aria-expanded="false" aria-controls="collapseExample">
  More Details
  </button>
</p>
<div class="collapse  mx-0 px-0" id="collapse'.$item_company['company_id'].'">
