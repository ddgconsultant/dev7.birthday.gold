...
$additionalstyles .= '
<style > 
/* Standard top margin for spacing */
.main-content { 
    overflow: hidden;
...
// Get real comments from database
$comments = [];
...
foreach ($comments as $comment) {
    ...
    $timeAgomessage = ['shortmessagevalue' => $social->formatTimeAgo($comment['created_at'])];
...
/// LEFT PANEL ===============================================================================
echo '
<!-- Left Panel: wider for large screens -->
<div class="col-lg-5 left-panel p-0 m-0">
';
...
echo '
</div> <!-- END OF Right Panel col-lg-8 -->
';

// Navigation Shortcut menu - HIDDEN FOR NOW
...
// Keyboard shortcut styles commented out for now
/* $additionalstyles.='
<style>
