...
<html data-bs-theme="light" lang="en-US" dir="ltr">
  ...
  <body>
   ...
   <div class="content">
           <div class="d-flex mb-4 mt-3"><span class="fa-stack me-2 ms-n1"><i class="bi bi-circle-fill fa-stack-2x text-300"></i><i class="fa-inverse fa-stack-1x text-primary fas fa-percentage"></i></span>
            <div class="col">
          ...
          <div class="row g-3 mb-3">
            ...
            <div class="col-sm-6 col-md-4">
              <div class="card overflow-hidden" style="min-width: 12rem">
                <div class="bg-holder bg-card" style="background-image:url(/public/assets/img/icons/spot-illustrations/corner-2.png);">
                </div>
                <!--/.bg-holder-->
            ...
            <div class="col-md-4">
              <div class="card overflow-hidden" style="min-width: 12rem">
                <div class="bg-holder bg-card" style="background-image:url(/public/assets/img/icons/spot-illustrations/corner-3.png);">
                </div>
                <!--/.bg-holder-->
              ...
              <div class="card h-100">
                <div class="card-header bg-body-tertiary d-flex flex-between-center py-2">
                  ...
                  <div class="dropdown font-sans-serif btn-reveal-trigger">
                    <button class="btn btn-link text-600 btn-sm dropdown-toggle dropdown-caret-none btn-reveal" type="button" id="dropdown-bandwidth-saved" data-bs-toggle="dropdown" data-boundary="viewport" aria-haspopup="true" aria-expanded="false"><span class="bi bi-three-dots fs-11"></span></button>
                ...
                <div class="card-header bg-body-tertiary py-2">
                  <div class="row flex-between-center">
                    ...
                    <div class="col-auto d-flex"><a class="btn btn-link btn-sm me-2" href="#!">View Details</a>
                      <div class="dropdown font-sans-serif btn-reveal-trigger">
                        <button class="btn btn-link text-600 btn-sm dropdown-toggle dropdown-caret-none btn-reveal" type="button" id="dropdown-top-products" data-bs-toggle="dropdown" data-boundary="viewport" aria-haspopup="true" aria-expanded="false"><span class="bi bi-three-dots fs-11"></span></button>
                ...
                <div class="card-header">
                  <div class="row flex-between-center">
                    ...
                    <div class="col-auto d-flex">
                      ...
                      <div class="dropdown font-sans-serif btn-reveal-trigger">
                        <button class="btn btn-link text-600 btn-sm dropdown-toggle dropdown-caret-none btn-reveal" type="button" id="dropdown-total-sales" data-bs-toggle="dropdown" data-boundary="viewport" aria-haspopup="true" aria-expanded="false"><span class="bi bi-three-dots fs-11"></span></button>
            ...
            <div class="col-md-6 col-xxl-4">
              <div class="card echart-session-by-browser-card h-100">
                <div class="card-header d-flex flex-between-center bg-body-tertiary py-2">
                  ...
                  <div class="dropdown font-sans-serif btn-reveal-trigger">
                    <button class="btn btn-link text-600 btn-sm dropdown-toggle dropdown-caret-none btn-reveal" type="button" id="dropdown-session-by-browser" data-bs-toggle="dropdown" data-boundary="viewport" aria-haspopup="true" aria-expanded="false"><span class="bi bi-three-dots fs-11"></span></button>
                    ...
                    <table class="table table-sm mb-0">
                      <tbody>
                        <tr>
                          ...
                          <td class="py-3">
                            <div class="d-flex align-items-center"><span class="bi bi-circle-fill fs-11 me-2 text-primary"></span>
                        ...
                        <tr>
                          ...
                          <td class="py-3">
                            <div class="d-flex align-items-center"><span class="bi bi-circle-fill fs-11 me-2 text-success"></span>
                        ...
                        <tr>
                          ...
                          <td class="py-3">
                            <div class="d-flex align-items-center"><span class="bi bi-circle-fill fs-11 me-2 text-info"></span>
            ...
            <div class="col-md-6 col-xxl-4">
              <div class="card">
                <div class="card-header d-flex align-items-center bg-body-tertiary py-2">
                  ...
                  <div class="dropdown font-sans-serif btn-reveal-trigger">
                    <button class="btn btn-link text-600 btn-sm dropdown-toggle dropdown-caret-none btn-reveal" type="button" id="dropdown-session-by-country" data-bs-toggle="dropdown" data-boundary="viewport" aria-haspopup="true" aria-expanded="false"><span class="bi bi-three-dots fs-11"></span></button>
            ...
            <div class="col-xxl-8">
              <div class="card mb-3">
                <div class="card-header d-flex flex-between-center bg-body-tertiary py-2">
                  ...
                  <div class="dropdown font-sans-serif btn-reveal-trigger">
                    <button class="btn btn-link text-600 btn-sm dropdown-toggle dropdown-caret-none btn-reveal" type="button" id="dropdown-active-user-report" data-bs-toggle="dropdown" data-boundary="viewport" aria-haspopup="true" aria-expanded="false"><span class="bi bi-three-dots fs-11"></span></button>
                    ...
                    <div class="col-md-auto mt-md-0">
                      <div class="row flex-md-column justify-content-between h-md-100 ms-0">
                        <div class="col border-end border-end-md-0 border-bottom-md pt-3">
                          <h6 class="fs-11 text-700"><span class="bi bi-circle-fill text-primary me-2"></span>Mobile</h6>
                          <h5 class="text-700 fs-9">10,325</h5>
                        </div>
                        <div class="col border-end border-end-md-0 border-bottom-md pt-3 pt-md-4">
                          <h6 class="fs-11 text-700"><span class="bi bi-circle-fill text-success me-2"></span>Desktop</h6>
                          <h5 class="text-700 fs-9">4,235</h5>
                        </div>
                        <div class="col pt-3 pt-md-4">
                          <h6 class="fs-11 text-700"><span class="bi bi-circle-fill text-info me-2"></span>Tablet</h6>
              ...
              <div class="row g-3">
                <div class="col-12">
                  <div class="card font-sans-serif">
                    <div class="card-body d-flex gap-3 flex-column flex-sm-row align-items-center"><img class="rounded-3" src="/public/assets/img/elearning/avatar/student.png" alt="" width="112" />
                      ...
                      <div class="dropdown btn-reveal-trigger position-absolute top-0 end-0 m-3">
                        <button class="btn btn-link btn-reveal text-600 btn-sm dropdown-toggle dropdown-caret-none" type="button" id="studentInfoDropdown" data-bs-toggle="dropdown" data-boundary="viewport" aria-haspopup="true" aria-expanded="false"><span class="bi bi-three-dots fs-11"></span></button>
            ...
            <div class="col-xxl-4">
              <div class="card h-100">
                <div class="card-header bg-body-tertiary d-flex flex-between-center py-2">
                  ...
                  <div class="dropdown font-sans-serif btn-reveal-trigger">
                    <button class="btn btn-link text-600 btn-sm dropdown-toggle dropdown-caret-none btn-reveal" type="button" id="dropdown-trending-keywords" data-bs-toggle="dropdown" data-boundary="viewport" aria-haspopup="true" aria-expanded="false"><span class="bi bi-three-dots fs-11"></span></button>
                      ...
                      <div class="row align-items-end h-100 mb-n1">
                        ...
                        <div class="col-6 col-sm-7">
                          <div class="lms-half-doughnut mt-n3 ms-auto">
                            ...
                            <p class="mb-0 mt-n6 text-center fs-8 fw-medium" data-countup='{"endValue":"69","suffix":"%"}'>0</p>
                          </div>
                        </div>
                      </div>
                    </div>
                      ...
                      <div class="row align-items-end h-100 mb-n1">
                        ...
                        <div class="col-6 col-sm-7">
                          <div class="lms-half-doughnut mt-n3 ms-auto">
                            ...
                            <p class="mb-0 mt-n6 text-center fs-8 fw-medium" data-countup='{"endValue":"64","suffix":"%"}'>0</p>
                          </div>
                        </div>
                      </div>
                    </div>
                      ...
                      <div class="row flex-between-center g-0">
                        ...
                        <div class="col-12 col-md-auto order-3 order-md-2">
                          <div class="d-flex flex-wrap gap-md-2">
                            <button class="btn btn-link text-decoration-none text-600 fs-11 px-0 me-2" id="onSaleCourse"><span class="bi bi-circle-fill text-primary me-1" data-fa-transform="shrink-3"></span>On Sale Course</button>
                            <button class="btn btn-link text-decoration-none text-600 fs-11 px-0" id="regularPaidCourse"><span class="bi bi-circle-fill text-warning me-1" data-fa-transform="shrink-3"></span>Regular Paid Course</button>
                          </div>
                        </div>
                        <div class="col-auto order-2 order-md-3">
                          <div class="dropdown font-sans-serif btn-reveal-trigger">
                            <button class="btn btn-link text-600 btn-sm dropdown-toggle dropdown-caret-none btn-reveal" type="button" id="dropdown-avg-enrollment-lms" data-bs-toggle="dropdown" data-boundary="viewport" aria-haspopup="true" aria-expanded="false"><span class="bi bi-three-dots fs-11"></span></button>
            ...
            <div class="col-12 col-xxl-8">
              <div class="card">
                <div class="card-header d-flex flex-between-center bg-body-tertiary py-2">
                  ...
                  <div class="dropdown font-sans-serif btn-reveal-trigger">
                    <button class="btn btn-link text-600 btn-sm dropdown-toggle dropdown-caret-none btn-reveal" type="button" id="dropdown-traffic-channel" data-bs-toggle="dropdown" data-boundary="viewport" aria-haspopup="true" aria-expanded="false"><span class="bi bi-three-dots fs-11"></span></button>
                ...
                <div class="card-footer border-top py-2">
                  <div class="row align-items-center gx-0" id="returning-customer-rate-footer">
                    <div class="col-auto me-2">
                      <div class="btn btn-sm d-flex align-items-center p-0 shadow-none" id="newMonth"><span class="bi bi-circle-fill text-primary fs-11 me-1"></span>New </div>
                    </div>
                    <div class="col-auto">
                      <div class="btn btn-sm d-flex align-items-center p-0 shadow-none" id="returningMonth"><span class="bi bi-circle-fill text-warning fs-11 me-1"></span>Returning </div>
                    </div>
              ...
              <div class="card h-100">
                ...
                <div class="card-body px-0 pt-4 pb-0">
                  <table class="table table-borderless font-sans-serif fw-medium fs-10">
                    <tbody>
                      <tr>
                        <td class="pb-2 pt-0"> <span class="bi bi-circle-fill fs-11 me-1 text-primary"></span>Allocated Budget</td>
                      ...
                      <tr>
                        <td class="pb-2 pt-0"> <span class="bi bi-circle-fill fs-11 me-1 text-warning"></span>Actual Spending</td>
            ...
            <div class="col-lg-6 col-xxl-7">
              <div class="card" id="LmsUserByLocationTable" data-list='{"valueNames":["country","users","revenue","native-support"],"page":4}'>
                <div class="card-header d-flex flex-between-center bg-body-tertiary py-2">
                  ...
                  <div class="dropdown font-sans-serif btn-reveal-trigger">
                    <button class="btn btn-link text-600 btn-sm dropdown-toggle dropdown-caret-none btn-reveal" type="button" id="lms-user-by-location" data-bs-toggle="dropdown" data-boundary="viewport" aria-haspopup="true" aria-expanded="false"><span class="bi bi-three-dots fs-11"></span></button>
                ...
                <div class="card-body pb-0 position-relative">
                  ...
                  <div class="position-absolute top-0 border mt-3 border-200 rounded-3 bg-body-tertiary">
                    <button class="btn btn-link btn-sm bg-100 rounded-bottom-0 px-2 user-by-location-map-zoom text-700" type="button"><span class="bi bi-plus fs-10"></span></button>
            ...
            <div class="col-lg-6 col-xxl-5">
              <div class="card h-100">
                <div class="card-header bg-body-tertiary d-flex flex-between-center py-2">
                  ...
                  <div class="dropdown font-sans-serif btn-reveal-trigger">
                    <button class="btn btn-link text-600 btn-sm dropdown-toggle dropdown-caret-none btn-reveal" type="button" id="lms-weekly-goal" data-bs-toggle="dropdown" data-boundary="viewport" aria-haspopup="true" aria-expanded="false"><span class="bi bi-three-dots fs-11"></span></button>
            ...
            <div class="col-xxl-4 col-md-6">
              <div class="card shopping-cart-bar-min-height h-100">
                <div class="card-header d-flex flex-between-center">
                  ...
                  <div class="dropdown font-sans-serif btn-reveal-trigger">
                    <button class="btn btn-link text-600 btn-sm dropdown-toggle dropdown-caret-none btn-reveal" type="button" id="dropdown-shopping-cart-bar" data-bs-toggle="dropdown" data-boundary="viewport" aria-haspopup="true" aria-expanded="false"><span class="bi bi-three-dots fs-11"></span></button>
              ...
              <div class="card h-100">
                ...
                <div class="card-footer border-top py-2 d-flex flex-between-center">
                  <div class="d-flex" id="gross-revenue-footer">
                    <div class="btn btn-sm d-flex align-items-center p-0 shadow-none" id="currentMonth" data-month="current"><span class="bi bi-circle-fill text-primary fs-11 me-1"></span><span class="text">Jan</span></div>
                    <div class="btn btn-sm d-flex align-items-center p-0 shadow-none ms-2" id="prevMonth" data-month="prev"><span class="bi bi-circle-fill text-300 fs-11 me-1"></span><span class="text">Dec</span></div>
            ...
            <div class="col-xxl-8">
              <div class="card">
                <div class="card-header d-flex flex-between-center">
                  ...
                  <div class="dropdown font-sans-serif btn-reveal-trigger">
                    <button class="btn btn-link text-600 btn-sm dropdown-toggle dropdown-caret-none btn-reveal" type="button" id="dropdown-project-statistics" data-bs-toggle="dropdown" data-boundary="viewport" aria-haspopup="true" aria-expanded="false"><span class="bi bi-three-dots fs-11"></span></button>
                ...
                <div class="card-body pt-0">
                  ...
                  <div class="avatar-group avatar-group-dense mb-3">
                    ...
                    <div class="avatar avatar-2xl border border-3 border-200 rounded-circle">
                      <img class="rounded-circle" src="/public/assets/img/team/2-thumb.png" alt="" />
                    ...
                    <div class="avatar avatar-2xl border border-3 border-200 rounded-circle">
                      <img class="rounded-circle" src="/public/assets/img/team/4-thumb.png" alt="" />

                    </div>
                    <div class="avatar avatar-2xl border border-3 border-200 rounded-circle">
                      <img class="rounded-circle" src="/public/assets/img/team/5-thumb.png" alt="" />
                  ...
                  <div class="d-flex flex-between-center rounded-3 bg-body-tertiary p-3 mb-2"><a href="#!">
                      <h6 class="mb-0"><span class="bi bi-circle-fill fs-10 me-3 text-primary"></span>Organizing UI</h6>
                    </a><a class="fs-11 text-600 mb-0" href="#!">ThemeWagon</a></div>
                  <div class="d-flex flex-between-center rounded-3 bg-body-tertiary p-3 mb-2"><a href="#!">
                      <h6 class="mb-0"><span class="bi bi-circle-fill fs-10 me-3 text-warning"></span>Create Mobile View</h6>
                    </a><a class="fs-11 text-600 mb-0" href="#!">Mailbluster</a></div>
                  <div class="d-flex flex-between-center rounded-3 bg-body-tertiary p-3 mb-2"><a href="#!">
                      <h6 class="mb-0"><span class="bi bi-circle-fill fs-10 me-3 text-secondary"></span>Create Landing Pages</h6>
                  ...
                  <div class="d-flex flex-between-center rounded-3 bg-body-tertiary p-3"><a href="#!">
                      <h6 class="mb-0"><span class="bi bi-circle-fill fs-10 me-3 text-info"></span>Front end issues</h6>
              ...
              <div class="card h-100">
                ...
                <div class="card-body pe-0 position-relative" id="candle-chart" dir="ltr">
                  <div class="btn-group position-absolute z-1 top-0 d-inline-block" role="group" style="left:20px;right:20px;">
                    <button class="btn btn-falcon-default btn-sm mb-1" data-zoom="in"><span class="bi bi-plus"></span></button>
          ...
          <div class="card h-100">
            ...
            <div class="card-footer bg-body-tertiary py-2">
              <div class="row flex-between-center g-0">
                <div class="col-auto">
                  <button class="btn btn-sm btn-link fs-11 text-600 text-decoration-none px-0 me-2" id="newCourseBrowsed"><span class="bi bi-circle-fill text-primary text-opacity-25 me-1" data-fa-transform="shrink-4"></span>New Courses Browsed</button>
                  <button class="btn btn-sm btn-link fs-11 text-600 text-decoration-none px-0" id="paidCourseBrowsed"><span class="bi bi-circle-fill text-primary me-1" data-fa-transform="shrink-4"></span>Paid Courses Browsed</button>
                </div>
          ...
          <div class="d-flex mb-4 mt-6"><span class="fa-stack me-2 ms-n1"><i class="bi bi-circle-fill fa-stack-2x text-300"></i><i class="fa-inverse fa-stack-1x text-primary fas fa-list" data-fa-transform="shrink-2"></i></span>
            <div class="col">
              ...
              <div class="row flex-between-center">
                ...
                <div class="col-6 col-sm-auto ms-auto text-end ps-0">
                  ...
                  <div id="table-purchases-replace-element">
                    <button class="btn btn-falcon-default btn-sm" type="button"><span class="bi bi-plus" data-fa-transform="shrink-3 down-2"></span><span class="d-none d-sm-inline-block ms-1">New</span></button>
                    <button class="btn btn-falcon-default btn-sm mx-2" type="button"><span class="bi bi-funnel" data-fa-transform="shrink-3 down-2"></span><span class="d-none d-sm-inline-block ms-1">Filter</span></button>
                ...
                <table class="table table-sm fs-10 mb-0 overflow-hidden">
                  ...
                  <tbody class="list" id="table-purchase-body">
                    <tr class="btn-reveal-trigger">
                      ...
                      <td class="align-middle text-center fs-9 white-space-nowrap payment"><small class="badge rounded badge-subtle-success false">Success</small>
                      </td>
                      <td class="align-middle text-end amount">$99</td>
                      <td class="align-middle white-space-nowrap text-end">
                        <div class="dropstart font-sans-serif position-static d-inline-block">
                          <button class="btn btn-link text-600 btn-sm dropdown-toggle btn-reveal float-end" type="button" id="dropdown-recent-purchase-table-0" data-bs-toggle="dropdown" data-boundary="window" aria-haspopup="true" aria-expanded="false" data-bs-reference="parent"><span class="bi bi-three-dots fs-10"></span></button>
                    ...
                    <tr class="btn-reveal-trigger">
                      ...
                      <td class="align-middle white-space-nowrap text-end">
                        <div class="dropstart font-sans-serif position-static d-inline-block">
                          <button class="btn btn-link text-600 btn-sm dropdown-toggle btn-reveal float-end" type="button" id="dropdown-recent-purchase-table-1" data-bs-toggle="dropdown" data-boundary="window" aria-haspopup="true" aria-expanded="false" data-bs-reference="parent"><span class="bi bi-three-dots fs-10"></span></button>
                    ...
                    <tr class="btn-reveal-trigger">
                      ...
                      <td class="align-middle text-center fs-9 white-space-nowrap payment"><small class="badge rounded badge-subtle-secondary dark__bg-1000">Blocked</small>
                      </td>
                      <td class="align-middle text-end amount">$199</td>
                      <td class="align-middle white-space-nowrap text-end">
                        <div class="dropstart font-sans-serif position-static d-inline-block">
                          <button class="btn btn-link text-600 btn-sm dropdown-toggle btn-reveal float-end" type="button" id="dropdown-recent-purchase-table-2" data-bs-toggle="dropdown" data-boundary="window" aria-haspopup="true" aria-expanded="false" data-bs-reference="parent"><span class="bi bi-three-dots fs-10"></span></button>
                    ...
                    <tr class="btn-reveal-trigger">
                      ...
                      <td class="align-middle white-space-nowrap text-end">
                        <div class="dropstart font-sans-serif position-static d-inline-block">
                          <button class="btn btn-link text-600 btn-sm dropdown-toggle btn-reveal float-end" type="button" id="dropdown-recent-purchase-table-3" data-bs-toggle="dropdown" data-boundary="window" aria-haspopup="true" aria-expanded="false" data-bs-reference="parent"><span class="bi bi-three-dots fs-10"></span></button>
                    ...
                    <tr class="btn-reveal-trigger">
                      ...
                      <td class="align-middle white-space-nowrap text-end">
                        <div class="dropstart font-sans-serif position-static d-inline-block">
                          <button class="btn btn-link text-600 btn-sm dropdown-toggle btn-reveal float-end" type="button" id="dropdown-recent-purchase-table-4" data-bs-toggle="dropdown" data-boundary="window" aria-haspopup="true" aria-expanded="false" data-bs-reference="parent"><span class="bi bi-three-dots fs-10"></span></button>
                    ...
                    <tr class="btn-reveal-trigger">
                      ...
                      <td class="align-middle text-center fs-9 white-space-nowrap payment"><small class="badge rounded badge-subtle-warning false">Pending</small>
                      </td>
                      <td class="align-middle text-end amount">$11</td>
                      <td class="align-middle white-space-nowrap text-end">
                        <div class="dropstart font-sans-serif position-static d-inline-block">
                          <button class="btn btn-link text-600 btn-sm dropdown-toggle btn-reveal float-end" type="button" id="dropdown-recent-purchase-table-5" data-bs-toggle="dropdown" data-boundary="window" aria-haspopup="true" aria-expanded="false" data-bs-reference="parent"><span class="bi bi-three-dots fs-10"></span></button>
                    ...
                    <tr class="btn-reveal-trigger">
                      ...
                      <td class="align-middle white-space-nowrap text-end">
                        <div class="dropstart font-sans-serif position-static d-inline-block">
                          <button class="btn btn-link text-600 btn-sm dropdown-toggle btn-reveal float-end" type="button" id="dropdown-recent-purchase-table-6" data-bs-toggle="dropdown" data-boundary="window" aria-haspopup="true" aria-expanded="false" data-bs-reference="parent"><span class="bi bi-three-dots fs-10"></span></button>
                    ...
                    <tr class="btn-reveal-trigger">
                      ...
                      <td class="align-middle white-space-nowrap text-end">
                        <div class="dropstart font-sans-serif position-static d-inline-block">
                          <button class="btn btn-link text-600 btn-sm dropdown-toggle btn-reveal float-end" type="button" id="dropdown-recent-purchase-table-7" data-bs-toggle="dropdown" data-boundary="window" aria-haspopup="true" aria-expanded="false" data-bs-reference="parent"><span class="bi bi-three-dots fs-10"></span></button>
                    ...
                    <tr class="btn-reveal-trigger">
                      ...
                      <td class="align-middle white-space-nowrap text-end">
                        <div class="dropstart font-sans-serif position-static d-inline-block">
                          <button class="btn btn-link text-600 btn-sm dropdown-toggle btn-reveal float-end" type="button" id="dropdown-recent-purchase-table-8" data-bs-toggle="dropdown" data-boundary="window" aria-haspopup="true" aria-expanded="false" data-bs-reference="parent"><span class="bi bi-three-dots fs-10"></span></button>
                    ...
                    <tr class="btn-reveal-trigger">
                      ...
                      <td class="align-middle white-space-nowrap text-end">
                        <div class="dropstart font-sans-serif position-static d-inline-block">
                          <button class="btn btn-link text-600 btn-sm dropdown-toggle btn-reveal float-end" type="button" id="dropdown-recent-purchase-table-9" data-bs-toggle="dropdown" data-boundary="window" aria-haspopup="true" aria-expanded="false" data-bs-reference="parent"><span class="bi bi-three-dots fs-10"></span></button>
                    ...
                    <tr class="btn-reveal-trigger">
                      ...
                      <td class="align-middle white-space-nowrap text-end">
                        <div class="dropstart font-sans-serif position-static d-inline-block">
                          <button class="btn btn-link text-600 btn-sm dropdown-toggle btn-reveal float-end" type="button" id="dropdown-recent-purchase-table-10" data-bs-toggle="dropdown" data-boundary="window" aria-haspopup="true" aria-expanded="false" data-bs-reference="parent"><span class="bi bi-three-dots fs-10"></span></button>
                    ...
                    <tr class="btn-reveal-trigger">
                      ...
                      <td class="align-middle white-space-nowrap text-end">
                        <div class="dropstart font-sans-serif position-static d-inline-block">
                          <button class="btn btn-link text-600 btn-sm dropdown-toggle btn-reveal float-end" type="button" id="dropdown-recent-purchase-table-11" data-bs-toggle="dropdown" data-boundary="window" aria-haspopup="true" aria-expanded="false" data-bs-reference="parent"><span class="bi bi-three-dots fs-10"></span></button>
                    ...
                    <tr class="btn-reveal-trigger">
                      ...
                      <td class="align-middle white-space-nowrap text-end">
                        <div class="dropstart font-sans-serif position-static d-inline-block">
                          <button class="btn btn-link text-600 btn-sm dropdown-toggle btn-reveal float-end" type="button" id="dropdown-recent-purchase-table-12" data-bs-toggle="dropdown" data-boundary="window" aria-haspopup="true" aria-expanded="false" data-bs-reference="parent"><span class="bi bi-three-dots fs-10"></span></button>
                    ...
                    <tr class="btn-reveal-trigger">
                      ...
                      <td class="align-middle white-space-nowrap text-end">
                        <div class="dropstart font-sans-serif position-static d-inline-block">
                          <button class="btn btn-link text-600 btn-sm dropdown-toggle btn-reveal float-end" type="button" id="dropdown-recent-purchase-table-13" data-bs-toggle="dropdown" data-boundary="window" aria-haspopup="true" aria-expanded="false" data-bs-reference="parent"><span class="bi bi-three-dots fs-10"></span></button>
                  ...
                  <tbody class="list" id="table-customers-body">
                    <tr class="btn-reveal-trigger">
                      ...
                      <td class="align-middle white-space-nowrap py-2 text-end">
                        <div class="dropdown font-sans-serif position-static">
                          <button class="btn btn-link text-600 btn-sm dropdown-toggle btn-reveal" type="button" id="customer-dropdown-0" data-bs-toggle="dropdown" data-boundary="window" aria-haspopup="true" aria-expanded="false"><span class="bi bi-three-dots fs-10"></span></button>
                    ...
                    <tr class="btn-reveal-trigger">
                      ...
                      <td class="name align-middle white-space-nowrap py-2"><a href="app/e-commerce/customer-details.html">
                          <div class="d-flex d-flex align-items-center">
                            <div class="avatar avatar-xl me-2">
                              <img class="rounded-circle" src="/public/assets/img/team/2.jpg" alt="" />
                      ...
                      <td class="align-middle white-space-nowrap py-2 text-end">
                        <div class="dropdown font-sans-serif position-static">
                          <button class="btn btn-link text-600 btn-sm dropdown-toggle btn-reveal" type="button" id="customer-dropdown-1" data-bs-toggle="dropdown" data-boundary="window" aria-haspopup="true" aria-expanded="false"><span class="bi bi-three-dots fs-10"></span></button>
                    ...
                    <tr class="btn-reveal-trigger">
                      ...
                      <td class="align-middle white-space-nowrap py-2 text-end">
                        <div class="dropdown font-sans-serif position-static">
                          <button class="btn btn-link text-600 btn-sm dropdown-toggle btn-reveal" type="button" id="customer-dropdown-2" data-bs-toggle="dropdown" data-boundary="window" aria-haspopup="true" aria-expanded="false"><span class="bi bi-three-dots fs-10"></span></button>
                    ...
                    <tr class="btn-reveal-trigger">
                      ...
                      <td class="align-middle white-space-nowrap py-2 text-end">
                        <div class="dropdown font-sans-serif position-static">
                          <button class="btn btn-link text-600 btn-sm dropdown-toggle btn-reveal" type="button" id="customer-dropdown-3" data-bs-toggle="dropdown" data-boundary="window" aria-haspopup="true" aria-expanded="false"><span class="bi bi-three-dots fs-10"></span></button>
                    ...
                    <tr class="btn-reveal-trigger">
                      ...
                      <td class="align-middle white-space-nowrap py-2 text-end">
                        <div class="dropdown font-sans-serif position-static">
                          <button class="btn btn-link text-600 btn-sm dropdown-toggle btn-reveal" type="button" id="customer-dropdown-4" data-bs-toggle="dropdown" data-boundary="window" aria-haspopup="true" aria-expanded="false"><span class="bi bi-three-dots fs-10"></span></button>
                    ...
                    <tr class="btn-reveal-trigger">
                      ...
                      <td class="align-middle white-space-nowrap py-2 text-end">
                        <div class="dropdown font-sans-serif position-static">
                          <button class="btn btn-link text-600 btn-sm dropdown-toggle btn-reveal" type="button" id="customer-dropdown-5" data-bs-toggle="dropdown" data-boundary="window" aria-haspopup="true" aria-expanded="false"><span class="bi bi-three-dots fs-10"></span></button>
                    ...
                    <tr class="btn-reveal-trigger">
                      ...
                      <td class="align-middle white-space-nowrap py-2 text-end">
                        <div class="dropdown font-sans-serif position-static">
                          <button class="btn btn-link text-600 btn-sm dropdown-toggle btn-reveal" type="button" id="customer-dropdown-6" data-bs-toggle="dropdown" data-boundary="window" aria-haspopup="true" aria-expanded="false"><span class="bi bi-three-dots fs-10"></span></button>
                    ...
                    <tr class="btn-reveal-trigger">
                      ...
                      <td class="name align-middle white-space-nowrap py-2"><a href="app/e-commerce/customer-details.html">
                          <div class="d-flex d-flex align-items-center">
                            <div class="avatar avatar-xl me-2">
                              <img class="rounded-circle" src="/public/assets/img/team/13.jpg" alt="" />
                      ...
                      <td class="align-middle white-space-nowrap py-2 text-end">
                        <div class="dropdown font-sans-serif position-static">
                          <button class="btn btn-link text-600 btn-sm dropdown-toggle btn-reveal" type="button" id="customer-dropdown-7" data-bs-toggle="dropdown" data-boundary="window" aria-haspopup="true" aria-expanded="false"><span class="bi bi-three-dots fs-10"></span></button>
                    ...
                    <tr class="btn-reveal-trigger">
                      ...
                      <td class="align-middle white-space-nowrap py-2 text-end">
                        <div class="dropdown font-sans-serif position-static">
                          <button class="btn btn-link text-600 btn-sm dropdown-toggle btn-reveal" type="button" id="customer-dropdown-8" data-bs-toggle="dropdown" data-boundary="window" aria-haspopup="true" aria-expanded="false"><span class="bi bi-three-dots fs-10"></span></button>
                    ...
                    <tr class="btn-reveal-trigger">
                      ...
                      <td class="align-middle white-space-nowrap py-2 text-end">
                        <div class="dropdown font-sans-serif position-static">
                          <button class="btn btn-link text-600 btn-sm dropdown-toggle btn-reveal" type="button" id="customer-dropdown-9" data-bs-toggle="dropdown" data-boundary="window" aria-haspopup="true" aria-expanded="false"><span class="bi bi-three-dots fs-10"></span></button>
                    ...
                    <tr class="btn-reveal-trigger">
                      ...
                      <td class="name align-middle white-space-nowrap py-2"><a href="app/e-commerce/customer-details.html">
                          <div class="d-flex d-flex align-items-center">
                            <div class="avatar avatar-xl me-2">
                              <img class="rounded-circle" src="/public/assets/img/team/9.jpg" alt="" />
                      ...
                      <td class="align-middle white-space-nowrap py-2 text-end">
                        <div class="dropdown font-sans-serif position-static">
                          <button class="btn btn-link text-600 btn-sm dropdown-toggle btn-reveal" type="button" id="customer-dropdown-10" data-bs-toggle="dropdown" data-boundary="window" aria-haspopup="true" aria-expanded="false"><span class="bi bi-three-dots fs-10"></span></button>
                    ...
                    <tr class="btn-reveal-trigger">
                      ...
                      <td class="name align-middle white-space-nowrap py-2"><a href="app/e-commerce/customer-details.html">
                          <div class="d-flex d-flex align-items-center">
                            <div class="avatar avatar-xl me-2">
                              <img class="rounded-circle" src="/public/assets/img/team/14.jpg" alt="" />
                      ...
                      <td class="align-middle white-space-nowrap py-2 text-end">
                        <div class="dropdown font-sans-serif position-static">
                          <button class="btn btn-link text-600 btn-sm dropdown-toggle btn-reveal" type="button" id="customer-dropdown-11" data-bs-toggle="dropdown" data-boundary="window" aria-haspopup="true" aria-expanded="false"><span class="bi bi-three-dots fs-10"></span></button>
                    ...
                    <tr class="btn-reveal-trigger">
                      ...
                      <td class="align-middle white-space-nowrap py-2 text-end">
                        <div class="dropdown font-sans-serif position-static">
                          <button class="btn btn-link text-600 btn-sm dropdown-toggle btn-reveal" type="button" id="customer-dropdown-12" data-bs-toggle="dropdown" data-boundary="window" aria-haspopup="true" aria-expanded="false"><span class="bi bi-three-dots fs-10"></span></button>
                    ...
                    <tr class="btn-reveal-trigger">
                      ...
                      <td class="align-middle white-space-nowrap py-2 text-end">
                        <div class="dropdown font-sans-serif position-static">
                          <button class="btn btn-link text-600 btn-sm dropdown-toggle btn-reveal" type="button" id="customer-dropdown-13" data-bs-toggle="dropdown" data-boundary="window" aria-haspopup="true" aria-expanded="false"><span class="bi bi-three-dots fs-10"></span></button>
                    ...
                    <tr class="btn-reveal-trigger">
                      ...
                      <td class="align-middle white-space-nowrap py-2 text-end">
                        <div class="dropdown font-sans-serif position-static">
                          <button class="btn btn-link text-600 btn-sm dropdown-toggle btn-reveal" type="button" id="customer-dropdown-14" data-bs-toggle="dropdown" data-boundary="window" aria-haspopup="true" aria-expanded="false"><span class="bi bi-three-dots fs-10"></span></button>
                    ...
                    <tr class="btn-reveal-trigger">
                      ...
                      <td class="name align-middle white-space-nowrap py-2"><a href="app/e-commerce/customer-details.html">
                          <div class="d-flex d-flex align-items-center">
                            <div class="avatar avatar-xl me-2">
                              <img class="rounded-circle" src="/public/assets/img/team/5.jpg" alt="" />
                      ...
                      <td class="align-middle white-space-nowrap py-2 text-end">
                        <div class="dropdown font-sans-serif position-static">
                          <button class="btn btn-link text-600 btn-sm dropdown-toggle btn-reveal" type="button" id="customer-dropdown-15" data-bs-toggle="dropdown" data-boundary="window" aria-haspopup="true" aria-expanded="false"><span class="bi bi-three-dots fs-10"></span></button>
                    ...
                    <tr class="btn-reveal-trigger">
                      ...
                      <td class="name align-middle white-space-nowrap py-2"><a href="app/e-commerce/customer-details.html">
                          <div class="d-flex d-flex align-items-center">
                            <div class="avatar avatar-xl me-2">
                              <img class="rounded-circle" src="/public/assets/img/team/6.jpg" alt="" />
                      ...
                      <td class="align-middle white-space-nowrap py-2 text-end">
                        <div class="dropdown font-sans-serif position-static">
                          <button class="btn btn-link text-600 btn-sm dropdown-toggle btn-reveal" type="button" id="customer-dropdown-16" data-bs-toggle="dropdown" data-boundary="window" aria-haspopup="true" aria-expanded="false"><span class="bi bi-three-dots fs-10"></span></button>
                    ...
                    <tr class="btn-reveal-trigger">
                      ...
                      <td class="align-middle white-space-nowrap py-2 text-end">
                        <div class="dropdown font-sans-serif position-static">
                          <button class="btn btn-link text-600 btn-sm dropdown-toggle btn-reveal" type="button" id="customer-dropdown-17" data-bs-toggle="dropdown" data-boundary="window" aria-haspopup="true" aria-expanded="false"><span class="bi bi-three-dots fs-10"></span></button>
                    ...
                    <tr class="btn-reveal-trigger">
                      ...
                      <td class="align-middle white-space-nowrap py-2 text-end">
                        <div class="dropdown font-sans-serif position-static">
                          <button class="btn btn-link text-600 btn-sm dropdown-toggle btn-reveal" type="button" id="customer-dropdown-18" data-bs-toggle="dropdown" data-boundary="window" aria-haspopup="true" aria-expanded="false"><span class="bi bi-three-dots fs-10"></span></button>
                    ...
                    <tr class="btn-reveal-trigger">
                      ...
                      <td class="align-middle white-space-nowrap py-2 text-end">
                        <div class="dropdown font-sans-serif position-static">
                          <button class="btn btn-link text-600 btn-sm dropdown-toggle btn-reveal" type="button" id="customer-dropdown-19" data-bs-toggle="dropdown" data-boundary="window" aria-haspopup="true" aria-expanded="false"><span class="bi bi-three-dots fs-10"></span></button>
                    ...
                    <tr class="btn-reveal-trigger">
                      ...
                      <td class="align-middle white-space-nowrap py-2 text-end">
                        <div class="dropdown font-sans-serif position-static">
                          <button class="btn btn-link text-600 btn-sm dropdown-toggle btn-reveal" type="button" id="customer-dropdown-20" data-bs-toggle="dropdown" data-boundary="window" aria-haspopup="true" aria-expanded="false"><span class="bi bi-three-dots fs-10"></span></button>
                    ...
                    <tr class="btn-reveal-trigger">
                      ...
                      <td class="align-middle white-space-nowrap py-2 text-end">
                        <div class="dropdown font-sans-serif position-static">
                          <button class="btn btn-link text-600 btn-sm dropdown-toggle btn-reveal" type="button" id="customer-dropdown-21" data-bs-toggle="dropdown" data-boundary="window" aria-haspopup="true" aria-expanded="false"><span class="bi bi-three-dots fs-10"></span></button>
                    ...
                    <tr class="btn-reveal-trigger">
                      ...
                      <td class="align-middle white-space-nowrap py-2 text-end">
                        <div class="dropdown font-sans-serif position-static">
                          <button class="btn btn-link text-600 btn-sm dropdown-toggle btn-reveal" type="button" id="customer-dropdown-22" data-bs-toggle="dropdown" data-boundary="window" aria-haspopup="true" aria-expanded="false"><span class="bi bi-three-dots fs-10"></span></button>
                    ...
                    <tr class="btn-reveal-trigger">
                      ...
                      <td class="align-middle white-space-nowrap py-2 text-end">
                        <div class="dropdown font-sans-serif position-static">
                          <button class="btn btn-link text-600 btn-sm dropdown-toggle btn-reveal" type="button" id="customer-dropdown-23" data-bs-toggle="dropdown" data-boundary="window" aria-haspopup="true" aria-expanded="false"><span class="bi bi-three-dots fs-10"></span></button>
                    ...
                    <tr class="btn-reveal-trigger">
                      ...
                      <td class="align-middle white-space-nowrap py-2 text-end">
                        <div class="dropdown font-sans-serif position-static">
                          <button class="btn btn-link text-600 btn-sm dropdown-toggle btn-reveal" type="button" id="customer-dropdown-24" data-bs-toggle="dropdown" data-boundary="window" aria-haspopup="true" aria-expanded="false"><span class="bi bi-three-dots fs-10"></span></button>
          ...
          <div class="card mb-3" id="enrolledCoursesTable" data-list='{"valueNames":["title","trainer","date","time","progress","price"]}'>
            <div class="card-header d-flex flex-between-center">
              ...
              <div>
                <button class="btn btn-falcon-default btn-sm me-2" type="button"><span class="bi bi-funnel fs-11"></span><span class="d-none d-sm-inline-block ms-1 align-middle">Filter</span></button>
                  ...
                  <tbody class="list">
                    <tr class="btn-reveal-trigger fw-semi-bold">
                      <td class="align-middle white-space-nowrap title" style="max-width: 23rem;">
                        <div class="d-flex gap-3 align-items-center position-relative"><img class="rounded-1 border border-200" src="/public/assets/img/elearning/courses/course3.png" width="60" alt="" /><a class="stretched-link text-truncate" href="app/e-learning/course/course-details.html">Advanced Design Tools for Modern Designs</a></div>
                      </td>
                      ...
                      <td class="align-middle text-end">
                        <div class="dropdown font-sans-serif position-static d-inline-block btn-reveal-trigger">
                          <button class="btn btn-link text-600 btn-sm dropdown-toggle btn-reveal dropdown-caret-none float-end" type="button" id="dropdown0" data-bs-toggle="dropdown" data-boundary="window" aria-haspopup="true" aria-expanded="false" data-bs-reference="parent"><span class="bi bi-three-dots fs-10"></span></button>
                    ...
                    <tr class="btn-reveal-trigger fw-semi-bold">
                      ...
                      <td class="align-middle text-end">
                        <div class="dropdown font-sans-serif position-static d-inline-block btn-reveal-trigger">
                          <button class="btn btn-link text-600 btn-sm dropdown-toggle btn-reveal dropdown-caret-none float-end" type="button" id="dropdown1" data-bs-toggle="dropdown" data-boundary="window" aria-haspopup="true" aria-expanded="false" data-bs-reference="parent"><span class="bi bi-three-dots fs-10"></span></button>
                    ...
                    <tr class="btn-reveal-trigger fw-semi-bold">
                      ...
                      <td class="align-middle text-end">
                        <div class="dropdown font-sans-serif position-static d-inline-block btn-reveal-trigger">
                          <button class="btn btn-link text-600 btn-sm dropdown-toggle btn-reveal dropdown-caret-none float-end" type="button" id="dropdown2" data-bs-toggle="dropdown" data-boundary="window" aria-haspopup="true" aria-expanded="false" data-bs-reference="parent"><span class="bi bi-three-dots fs-10"></span></button>
                    ...
                    <tr class="btn-reveal-trigger fw-semi-bold">
                      ...
                      <td class="align-middle text-end">
                        <div class="dropdown font-sans-serif position-static d-inline-block btn-reveal-trigger">
                          <button class="btn btn-link text-600 btn-sm dropdown-toggle btn-reveal dropdown-caret-none float-end" type="button" id="dropdown3" data-bs-toggle="dropdown" data-boundary="window" aria-haspopup="true" aria-expanded="false" data-bs-reference="parent"><span class="bi bi-three-dots fs-10"></span></button>
                    ...
                    <tr class="btn-reveal-trigger fw-semi-bold">
                      ...
                      <td class="align-middle text-end">
                        <div class="dropdown font-sans-serif position-static d-inline-block btn-reveal-trigger">
                          <button class="btn btn-link text-600 btn-sm dropdown-toggle btn-reveal dropdown-caret-none float-end" type="button" id="dropdown4" data-bs-toggle="dropdown" data-boundary="window" aria-haspopup="true" aria-expanded="false" data-bs-reference="parent"><span class="bi bi-three-dots fs-10"></span></button>
                    ...
                    <tr class="btn-reveal-trigger fw-semi-bold">
                      ...
                      <td class="align-middle text-end">
                        <div class="dropdown font-sans-serif position-static d-inline-block btn-reveal-trigger">
                          <button class="btn btn-link text-600 btn-sm dropdown-toggle btn-reveal dropdown-caret-none float-end" type="button" id="dropdown5" data-bs-toggle="dropdown" data-boundary="window" aria-haspopup="true" aria-expanded="false" data-bs-reference="parent"><span class="bi bi-three-dots fs-10"></span></button>
                        ...
                        <table class="table fs-10 mb-0 overflow-hidden">
                          ...
                          <tbody class="list">
                            <tr class="btn-reveal-trigger fw-semi-bold">
                              ...
                              <td class="align-middle white-space-nowrap text-end">
                                <div class="dropstart font-sans-serif position-static d-inline-block">
                                  <button class="btn btn-link text-600 btn-sm dropdown-toggle btn-reveal float-end" type="button" id="dropdown-popularPaidCourses-1" data-bs-toggle="dropdown" data-boundary="window" aria-haspopup="true" aria-expanded="false" data-bs-reference="parent"><span class="bi bi-three-dots fs-10"></span></button>
                            ...
                            <tr class="btn-reveal-trigger fw-semi-bold">
                              ...
                              <td class="align-middle white-space-nowrap text-end">
                                <div class="dropstart font-sans-serif position-static d-inline-block">
                                  <button class="btn btn-link text-600 btn-sm dropdown-toggle btn-reveal float-end" type="button" id="dropdown-popularPaidCourses-2" data-bs-toggle="dropdown" data-boundary="window" aria-haspopup="true" aria-expanded="false" data-bs-reference="parent"><span class="bi bi-three-dots fs-10"></span></button>
                            ...
                            <tr class="btn-reveal-trigger fw-semi-bold">
                              ...
                              <td class="align-middle white-space-nowrap text-end">
                                <div class="dropstart font-sans-serif position-static d-inline-block">
                                  <button class="btn btn-link text-600 btn-sm dropdown-toggle btn-reveal float-end" type="button" id="dropdown-popularPaidCourses-3" data-bs-toggle="dropdown" data-boundary="window" aria-haspopup="true" aria-expanded="false" data-bs-reference="parent"><span class="bi bi-three-dots fs-10"></span></button>
                            ...
                            <tr class="btn-reveal-trigger fw-semi-bold">
                              ...
                              <td class="align-middle white-space-nowrap text-end">
                                <div class="dropstart font-sans-serif position-static d-inline-block">
                                  <button class="btn btn-link text-600 btn-sm dropdown-toggle btn-reveal float-end" type="button" id="dropdown-popularPaidCourses-4" data-bs-toggle="dropdown" data-boundary="window" aria-haspopup="true" aria-expanded="false" data-bs-reference="parent"><span class="bi bi-three-dots fs-10"></span></button>
                        ...
                        <table class="table fs-10 mb-0 overflow-hidden">
                          ...
                          <tbody class="list">
                            <tr class="btn-reveal-trigger fw-semi-bold">
                              ...
                              <td class="align-middle white-space-nowrap text-end">
                                <div class="dropstart font-sans-serif position-static d-inline-block">
                                  <button class="btn btn-link text-600 btn-sm dropdown-toggle btn-reveal float-end" type="button" id="dropdown-popularFreeCourses-1" data-bs-toggle="dropdown" data-boundary="window" aria-haspopup="true" aria-expanded="false" data-bs-reference="parent"><span class="bi bi-three-dots fs-10"></span></button>
                            ...
                            <tr class="btn-reveal-trigger fw-semi-bold">
                              ...
                              <td class="align-middle white-space-nowrap text-end">
                                <div class="dropstart font-sans-serif position-static d-inline-block">
                                  <button class="btn btn-link text-600 btn-sm dropdown-toggle btn-reveal float-end" type="button" id="dropdown-popularFreeCourses-2" data-bs-toggle="dropdown" data-boundary="window" aria-haspopup="true" aria-expanded="false" data-bs-reference="parent"><span class="bi bi-three-dots fs-10"></span></button>
                            ...
                            <tr class="btn-reveal-trigger fw-semi-bold">
                              ...
                              <td class="align-middle white-space-nowrap text-end">
                                <div class="dropstart font-sans-serif position-static d-inline-block">
                                  <button class="btn btn-link text-600 btn-sm dropdown-toggle btn-reveal float-end" type="button" id="dropdown-popularFreeCourses-3" data-bs-toggle="dropdown" data-boundary="window" aria-haspopup="true" aria-expanded="false" data-bs-reference="parent"><span class="bi bi-three-dots fs-10"></span></button>
                            ...
                            <tr class="btn-reveal-trigger fw-semi-bold">
                              ...
                              <td class="align-middle white-space-nowrap text-end">
                                <div class="dropstart font-sans-serif position-static d-inline-block">
                                  <button class="btn btn-link text-600 btn-sm dropdown-toggle btn-reveal float-end" type="button" id="dropdown-popularFreeCourses-4" data-bs-toggle="dropdown" data-boundary="window" aria-haspopup="true" aria-expanded="false" data-bs-reference="parent"><span class="bi bi-three-dots fs-10"></span></button>
                        ...
                        <table class="table fs-10 mb-0 overflow-hidden">
                          ...
                          <tbody class="list">
                            <tr class="btn-reveal-trigger fw-semi-bold">
                              ...
                              <td class="align-middle white-space-nowrap text-end">
                                <div class="dropstart font-sans-serif position-static d-inline-block">
                                  <button class="btn btn-link text-600 btn-sm dropdown-toggle btn-reveal float-end" type="button" id="dropdown-topPaidCourses-1" data-bs-toggle="dropdown" data-boundary="window" aria-haspopup="true" aria-expanded="false" data-bs-reference="parent"><span class="bi bi-three-dots fs-10"></span></button>
                            ...
                            <tr class="btn-reveal-trigger fw-semi-bold">
                              ...
                              <td class="align-middle white-space-nowrap text-end">
                                <div class="dropstart font-sans-serif position-static d-inline-block">
                                  <button class="btn btn-link text-600 btn-sm dropdown-toggle btn-reveal float-end" type="button" id="dropdown-topPaidCourses-2" data-bs-toggle="dropdown" data-boundary="window" aria-haspopup="true" aria-expanded="false" data-bs-reference="parent"><span class="bi bi-three-dots fs-10"></span></button>
                            ...
                            <tr class="btn-reveal-trigger fw-semi-bold">
                              ...
                              <td class="align-middle white-space-nowrap text-end">
                                <div class="dropstart font-sans-serif position-static d-inline-block">
                                  <button class="btn btn-link text-600 btn-sm dropdown-toggle btn-reveal float-end" type="button" id="dropdown-topPaidCourses-3" data-bs-toggle="dropdown" data-boundary="window" aria-haspopup="true" aria-expanded="false" data-bs-reference="parent"><span class="bi bi-three-dots fs-10"></span></button>
                            ...
                            <tr class="btn-reveal-trigger fw-semi-bold">
                              ...
                              <td class="align-middle white-space-nowrap text-end">
                                <div class="dropstart font-sans-serif position-static d-inline-block">
                                  <button class="btn btn-link text-600 btn-sm dropdown-toggle btn-reveal float-end" type="button" id="dropdown-topPaidCourses-4" data-bs-toggle="dropdown" data-boundary="window" aria-haspopup="true" aria-expanded="false" data-bs-reference="parent"><span class="bi bi-three-dots fs-10"></span></button>
                        ...
                        <table class="table fs-10 mb-0 overflow-hidden">
                          ...
                          <tbody class="list">
                            <tr class="btn-reveal-trigger fw-semi-bold">
                              ...
                              <td class="align-middle white-space-nowrap text-end">
                                <div class="dropstart font-sans-serif position-static d-inline-block">
                                  <button class="btn btn-link text-600 btn-sm dropdown-toggle btn-reveal float-end" type="button" id="dropdown-topFreeCourses-1" data-bs-toggle="dropdown" data-boundary="window" aria-haspopup="true" aria-expanded="false" data-bs-reference="parent"><span class="bi bi-three-dots fs-10"></span></button>
                            ...
                            <tr class="btn-reveal-trigger fw-semi-bold">
                              ...
                              <td class="align-middle white-space-nowrap text-end">
                                <div class="dropstart font-sans-serif position-static d-inline-block">
                                  <button class="btn btn-link text-600 btn-sm dropdown-toggle btn-reveal float-end" type="button" id="dropdown-topFreeCourses-2" data-bs-toggle="dropdown" data-boundary="window" aria-haspopup="true" aria-expanded="false" data-bs-reference="parent"><span class="bi bi-three-dots fs-10"></span></button>
                            ...
                            <tr class="btn-reveal-trigger fw-semi-bold">
                              ...
                              <td class="align-middle white-space-nowrap text-end">
                                <div class="dropstart font-sans-serif position-static d-inline-block">
                                  <button class="btn btn-link text-600 btn-sm dropdown-toggle btn-reveal float-end" type="button" id="dropdown-topFreeCourses-3" data-bs-toggle="dropdown" data-boundary="window" aria-haspopup="true" aria-expanded="false" data-bs-reference="parent"><span class="bi bi-three-dots fs-10"></span></button>
                            ...
                            <tr class="btn-reveal-trigger fw-semi-bold">
                              ...
                              <td class="align-middle white-space-nowrap text-end">
                                <div class="dropstart font-sans-serif position-static d-inline-block">
                                  <button class="btn btn-link text-600 btn-sm dropdown-toggle btn-reveal float-end" type="button" id="dropdown-topFreeCourses-4" data-bs-toggle="dropdown" data-boundary="window" aria-haspopup="true" aria-expanded="false" data-bs-reference="parent"><span class="bi bi-three-dots fs-10"></span></button>
            ...
            <div class="col-lg-4">
              <div class="card h-100 mb-3">
                <div class="card-header bg-body-tertiary d-flex flex-between-center py-2">
                  ...
                  <div class="dropdown font-sans-serif position-static d-inline-block btn-reveal-trigger">
                    <button class="btn btn-link text-600 btn-sm dropdown-toggle btn-reveal dropdown-caret-none" type="button" id="dropdown-payment-methods" data-bs-toggle="dropdown" data-boundary="window" aria-haspopup="true" aria-expanded="false" data-bs-reference="parent"><span class="bi bi-three-dots fs-10"></span></button>
                  ...
                  <div class="row g-3 h-100">
                    <div class="col-sm-6 col-lg-12">
                      <div class="card position-relative rounded-4">
                        <div class="bg-holder bg-card rounded-4" style="background-image:url(/public/assets/img/icons/spot-illustrations/corner-2.png);">
                        </div>
                        <!--/.bg-holder-->

                        <div class="card-body p-3 pt-5 pt-xxl-4"><img class="mb-3" src="/public/assets/img/icons/chip.png" alt="" width="30" />
                          <h6 class="text-primary font-base lh-1 mb-1">**** **** **** 9876</h6>
                          <h6 class="fs-11 fw-semi-bold text-facebook mb-3">12/26</h6>
                          <h6 class="mb-0 text-facebook">Michael Giacchino</h6><img class="position-absolute end-0 bottom-0 mb-2 me-2" src="/public/assets/img/icons/master-card.png" alt="" width="70" />
                        </div>
                      </div>
                    </div>
                    <div class="col-sm-6 col-lg-12">
          ...
          <div class="row g-3 mb-3">
              ...
              <div class="card h-lg-100">
                ...
                <div class="card-body pb-0">
                  <div class="d-flex mb-3 hover-actions-trigger align-items-center">
                    <div class="file-thumbnail"><img class="border h-100 w-100 object-fit-cover rounded-2" src="/public/assets/img/products/3-thumb.png" alt="" />
                    </div>
                    <div class="ms-3 flex-shrink-1 flex-grow-1">
                      ...
                      <div class="hover-actions end-0 top-50 translate-middle-y"><a class="btn btn-tertiary border-300 btn-sm me-1 text-600" data-bs-toggle="tooltip" data-bs-placement="top" title="Download" href="/public/assets/img/icons/cloud-download.svg" download="download"><img src="/public/assets/img/icons/cloud-download.svg" alt="" width="15" /></a>
                        <button class="btn btn-tertiary border-300 btn-sm me-1 text-600 shadow-none" type="button" data-bs-toggle="tooltip" data-bs-placement="top" title="Edit"><img src="/public/assets/img/icons/edit-alt.svg" alt="" width="15" /></button>
                      </div>
                    </div>
                  </div>
                  <hr class="text-200" />
                  <div class="d-flex mb-3 hover-actions-trigger align-items-center">
                    <div class="file-thumbnail"><img class="img-fluid" src="/public/assets/img/icons/zip.png" alt="" />
                    </div>
                    <div class="ms-3 flex-shrink-1 flex-grow-1">
                  ...
                  <hr class="text-200" />
                  <div class="d-flex mb-3 hover-actions-trigger align-items-center">
                    <div class="file-thumbnail"><img class="border h-100 w-100 object-fit-cover rounded-2" src="/public/assets/img/products/2-thumb.png" alt="" />
                    </div>
                    <div class="ms-3 flex-shrink-1 flex-grow-1">
                  ...
                  <hr class="text-200" />
                  <div class="d-flex mb-3 hover-actions-trigger align-items-center">
                    <div class="file-thumbnail"><img class="img-fluid" src="/public/assets/img/icons/docs.png" alt="" />
                    </div>
                    <div class="ms-3 flex-shrink-1 flex-grow-1">
            ...
            <div class="col-lg-5 col-xxl-4">
              <div class="card">
                ...
                <div class="card-body p-0">
                  <div class="d-flex justify-content-between border-top hover-actions-trigger btn-reveal-trigger px-x1 border-200 todo-list-item">
                    ...
                    <div class="d-flex align-items-center">
                      ...
                      <div class="dropdown font-sans-serif btn-reveal-trigger">
                        <button class="btn btn-link text-600 btn-sm dropdown-toggle dropdown-caret-none btn-reveal-sm transition-none" type="button" id="management-to-do-list-0" data-bs-toggle="dropdown" data-boundary="viewport" aria-haspopup="true" aria-expanded="false"><span class="bi bi-three-dots fs-11"></span></button>
                  ...
                  <div class="d-flex justify-content-between border-top hover-actions-trigger btn-reveal-trigger px-x1 border-200 todo-list-item">
                    ...
                    <div class="d-flex align-items-center">
                      ...
                      <div class="dropdown font-sans-serif btn-reveal-trigger">
                        <button class="btn btn-link text-600 btn-sm dropdown-toggle dropdown-caret-none btn-reveal-sm transition-none" type="button" id="management-to-do-list-1" data-bs-toggle="dropdown" data-boundary="viewport" aria-haspopup="true" aria-expanded="false"><span class="bi bi-three-dots fs-11"></span></button>
                  ...
                  <div class="d-flex justify-content-between border-top hover-actions-trigger btn-reveal-trigger px-x1 border-200 todo-list-item">
                    ...
                    <div class="d-flex align-items-center">
                      ...
                      <div class="dropdown font-sans-serif btn-reveal-trigger">
                        <button class="btn btn-link text-600 btn-sm dropdown-toggle dropdown-caret-none btn-reveal-sm transition-none" type="button" id="management-to-do-list-2" data-bs-toggle="dropdown" data-boundary="viewport" aria-haspopup="true" aria-expanded="false"><span class="bi bi-three-dots fs-11"></span></button>
                  ...
                  <div class="d-flex justify-content-between border-top hover-actions-trigger btn-reveal-trigger px-x1 border-200 todo-list-item">
                    ...
                    <div class="d-flex align-items-center">
                      ...
                      <div class="dropdown font-sans-serif btn-reveal-trigger">
                        <button class="btn btn-link text-600 btn-sm dropdown-toggle dropdown-caret-none btn-reveal-sm transition-none" type="button" id="management-to-do-list-3" data-bs-toggle="dropdown" data-boundary="viewport" aria-haspopup="true" aria-expanded="false"><span class="bi bi-three-dots fs-11"></span></button>
                  ...
                  <div class="d-flex justify-content-between border-top hover-actions-trigger btn-reveal-trigger px-x1 border-200 todo-list-item">
                    ...
                    <div class="d-flex align-items-center">
                      ...
                      <div class="dropdown font-sans-serif btn-reveal-trigger">
                        <button class="btn btn-link text-600 btn-sm dropdown-toggle dropdown-caret-none btn-reveal-sm transition-none" type="button" id="management-to-do-list-4" data-bs-toggle="dropdown" data-boundary="viewport" aria-haspopup="true" aria-expanded="false"><span class="bi bi-three-dots fs-11"></span></button>
                  ...
                  <div class="d-flex justify-content-between border-top hover-actions-trigger btn-reveal-trigger px-x1 border-200 todo-list-item">
                    ...
                    <div class="d-flex align-items-center">
                      ...
                      <div class="dropdown font-sans-serif btn-reveal-trigger">
                        <button class="btn btn-link text-600 btn-sm dropdown-toggle dropdown-caret-none btn-reveal-sm transition-none" type="button" id="management-to-do-list-5" data-bs-toggle="dropdown" data-boundary="viewport" aria-haspopup="true" aria-expanded="false"><span class="bi bi-three-dots fs-11"></span></button>
                ...
                <div class="card-footer bg-body-tertiary p-0"><a class="btn btn-sm btn-link d-block py-2" href="#!"><span class="bi bi-plus me-1 fs-11"></span>Add New Task</a></div>
              </div>
            </div>
          </div>
          <div class="row g-3 mb-3">
                      ...
                      <tbody>
                          ...
                          <td>
                            <div class="d-flex align-items-center position-relative">
                              <div class="avatar avatar-2xl status-online">
                                <img class="rounded-circle" src="/public/assets/img/team/7.jpg" alt="" />
                          ...
                          <td>
                            <div class="d-flex align-items-center position-relative">
                              <div class="avatar avatar-2xl status-away">
                                <img class="rounded-circle" src="/public/assets/img/team/12.jpg" alt="" />
                          ...
                          <td>
                            <div class="d-flex align-items-center position-relative">
                              <div class="avatar avatar-2xl status-do-not-disturb">
                                <img class="rounded-circle" src="/public/assets/img/team/16.jpg" alt="" />
                        ...
                        <tr>
                          <td>
                            <div class="d-flex align-items-center position-relative">
                              <div class="avatar avatar-2xl status-online">
                                <img class="rounded-circle" src="/public/assets/img/team/25.jpg" alt="" />
            ...
            <div class="col-lg-4">
              <div class="card h-100">
                <div class="card-header bg-body-tertiary py-2 d-flex flex-between-center">
                  ...
                  <div class="dropdown font-sans-serif btn-reveal-trigger">
                    <button class="btn btn-link text-600 btn-sm dropdown-toggle dropdown-caret-none btn-reveal" type="button" id="dropdown-members-activity" data-bs-toggle="dropdown" data-boundary="viewport" aria-haspopup="true" aria-expanded="false"><span class="bi bi-three-dots fs-11"></span></button>
                ...
                <div class="card-body members-activity scrollbar-overlay">
                  <div class="row g-2 mb-4">
                    ...
                    <div class="col-4 position-relative"><img class="w-100" src="/public/assets/img/management/activity-1.png" alt="..." />
                      <div class="badge rounded-pill position-absolute top-100 start-50 translate-middle badge-subtle-danger">20%</div>
                    </div>
                    <div class="col-4 position-relative"><img class="w-100" src="/public/assets/img/management/activity-2.png" alt="..." />
                      <div class="badge rounded-pill position-absolute top-100 start-50 translate-middle badge-subtle-primary">67%</div>
                    </div>
                    <div class="col-4 position-relative"><img class="w-100" src="/public/assets/img/management/activity-3.png" alt="..." />
                  ...
                  <div class="row g-2 mb-4">
                    ...
                    <div class="col-4 position-relative"><img class="w-100" src="/public/assets/img/management/activity-4.png" alt="..." />
                      <div class="badge rounded-pill position-absolute top-100 start-50 translate-middle badge-subtle-success">20%</div>
                    </div>
                    <div class="col-4 position-relative"><img class="w-100" src="/public/assets/img/management/activity-5.png" alt="..." />
                      <div class="badge rounded-pill position-absolute top-100 start-50 translate-middle badge-subtle-danger">67%</div>
                    </div>
                    <div class="col-4 position-relative"><img class="w-100" src="/public/assets/img/management/activity-6.png" alt="..." />
                  ...
                  <div class="row g-2 mb-4">
                    ...
                    <div class="col-4 position-relative"><img class="w-100" src="/public/assets/img/management/activity-7.png" alt="..." />
                      <div class="badge rounded-pill position-absolute top-100 start-50 translate-middle badge-subtle-danger">20%</div>
                    </div>
                    <div class="col-4 position-relative"><img class="w-100" src="/public/assets/img/management/activity-8.png" alt="..." />
                      <div class="badge rounded-pill position-absolute top-100 start-50 translate-middle badge-subtle-success">67%</div>
                    </div>
                    <div class="col-4 position-relative"><img class="w-100" src="/public/assets/img/management/activity-9.png" alt="..." />
                      <div class="badge rounded-pill position-absolute top-100 start-50 translate-middle badge-subtle-primary">89%</div>
                    </div>
                  </div>
                </div>
            ...
            <div class="col-xxl-8">
              <div class="card overflow-hidden">
                <div class="card-header d-flex flex-between-center bg-body-tertiary py-2">
                  ...
                  <div class="dropdown font-sans-serif btn-reveal-trigger">
                    <button class="btn btn-link text-600 btn-sm dropdown-toggle dropdown-caret-none btn-reveal" type="button" id="dropdown-transaction-summary" data-bs-toggle="dropdown" data-boundary="viewport" aria-haspopup="true" aria-expanded="false"><span class="bi bi-three-dots fs-11"></span></button>
                    ...
                    <table class="table table-dashboard mb-0 fs-10">
                      <tr>
                        <td class="align-middle ps-0 text-nowrap">
                          <div class="d-flex position-relative align-items-center"><img class="d-flex align-self-center me-2" src="/public/assets/img/logos/atlassian.png" alt="" width="30" />
                      ...
                      <tr>
                        <td class="align-middle ps-0 text-nowrap">
                          <div class="d-flex position-relative align-items-center"><img class="d-flex align-self-center me-2" src="/public/assets/img/logos/hubstaff.png" alt="" width="30" />
                            <div class="flex-1"><a class="stretched-link" href="#!">
                      ...
                      <tr>
                        <td class="align-middle ps-0 text-nowrap">
                          <div class="d-flex position-relative align-items-center"><img class="d-flex align-self-center me-2" src="/public/assets/img/logos/bs-5.png" alt="" width="30" />
                            <div class="flex-1"><a class="stretched-link" href="#!">
                      ...
                      <tr>
                        <td class="align-middle ps-0 text-nowrap">
                          <div class="d-flex position-relative align-items-center"><img class="d-flex align-self-center me-2" src="/public/assets/img/logos/asana-logo.png" alt="" width="30" />
                            <div class="flex-1"><a class="stretched-link" href="#!">
                      ...
                      <tr>
                        <td class="align-middle ps-0 text-nowrap">
                          <div class="d-flex position-relative align-items-center"><img class="d-flex align-self-center me-2" src="/public/assets/img/logos/adobe-creative-cloud.png" alt="" width="30" />
                            <div class="flex-1"><a class="stretched-link" href="#!">
                      ...
                      <tr>
                        <td class="align-middle ps-0 text-nowrap">
                          <div class="d-flex position-relative align-items-center"><img class="d-flex align-self-center me-2" src="/public/assets/img/logos/coursera.png" alt="" width="30" />
                            <div class="flex-1"><a class="stretched-link" href="#!">
                      ...
                      <tr class="border-0">
                        <td class="align-middle ps-0 text-nowrap border-0">
                          <div class="d-flex position-relative align-items-center"><img class="d-flex align-self-center me-2" src="/public/assets/img/logos/medium.png" alt="" width="30" />
                            <div class="flex-1"><a class="stretched-link" href="#!">
            ...
            <div class="col-md-6 col-xxl-7">
              <div class="card h-100">
                <div class="card-header d-flex flex-between-center bg-body-tertiary py-2">
                  ...
                  <div class="dropdown font-sans-serif btn-reveal-trigger">
                    <button class="btn btn-link text-600 btn-sm dropdown-toggle dropdown-caret-none btn-reveal" type="button" id="dropdown-campaign-perfomance" data-bs-toggle="dropdown" data-boundary="viewport" aria-haspopup="true" aria-expanded="false"><span class="bi bi-three-dots fs-11"></span></button>
                        ...
                        <tr>
                          ...
                          <td>
                            <div class="avatar-group justify-content-end">
                              ...
                              <div class="avatar avatar-xl border border-3 border-200 rounded-circle">
                                <img class="rounded-circle" src="/public/assets/img/team/18.jpg" alt="" />
                ...
                <div class="card-header border-bottom border-200 px-0">
                  <div class="d-lg-flex justify-content-between">
                    ...
                    <div class="d-flex align-items-center justify-content-between justify-content-lg-end px-x1">
                      <button class="btn btn-sm btn-falcon-default" type="button"><span class="bi bi-funnel" data-fa-transform="shrink-4 down-1"></span><span class="ms-1 d-none d-sm-inline-block">Filter</span></button>
          ...
          <div class="d-flex mb-4 mt-6"><span class="fa-stack me-2 ms-n1"><i class="bi bi-circle-fill fa-stack-2x text-300"></i><i class="fa-inverse fa-stack-1x text-primary fas fa-cart-plus" data-fa-transform="shrink-4"></i></span>
            <div class="col">
            ...
            <div class="card-body p-0">
              ...
              <div class="row gx-x1 mx-0 align-items-center border-bottom border-200">
                <div class="col-8 py-3 px-x1">
                  <div class="d-flex align-items-center"><a href="app/e-commerce/product/product-details.html"><img class="img-fluid rounded-1 me-3 d-none d-md-block" src="/public/assets/img/products/1.jpg" alt="" width="60" /></a>
                    <div class="flex-1">
              ...
              <div class="row gx-x1 mx-0 align-items-center border-bottom border-200">
                <div class="col-8 py-3 px-x1">
                  <div class="d-flex align-items-center"><a href="app/e-commerce/product/product-details.html"><img class="img-fluid rounded-1 me-3 d-none d-md-block" src="/public/assets/img/products/2.jpg" alt="" width="60" /></a>
                    <div class="flex-1">
              ...
              <div class="row gx-x1 mx-0 align-items-center border-bottom border-200">
                <div class="col-8 py-3 px-x1">
                  <div class="d-flex align-items-center"><a href="app/e-commerce/product/product-details.html"><img class="img-fluid rounded-1 me-3 d-none d-md-block" src="/public/assets/img/products/4.jpg" alt="" width="60" /></a>
                    <div class="flex-1">
              ...
              <div class="row gx-x1 mx-0 align-items-center border-bottom border-200">
                <div class="col-8 py-3 px-x1">
                  <div class="d-flex align-items-center"><a href="app/e-commerce/product/product-details.html"><img class="img-fluid rounded-1 me-3 d-none d-md-block" src="/public/assets/img/products/3.jpg" alt="" width="60" /></a>
                    <div class="flex-1">
              ...
              <div class="row gx-x1 mx-0 align-items-center border-bottom border-200">
                <div class="col-8 py-3 px-x1">
                  <div class="d-flex align-items-center"><a href="app/e-commerce/product/product-details.html"><img class="img-fluid rounded-1 me-3 d-none d-md-block" src="/public/assets/img/products/5.jpg" alt="" width="60" /></a>
                    <div class="flex-1">
              ...
              <div class="row gx-x1 mx-0 align-items-center border-bottom border-200">
                <div class="col-8 py-3 px-x1">
                  <div class="d-flex align-items-center"><a href="app/e-commerce/product/product-details.html"><img class="img-fluid rounded-1 me-3 d-none d-md-block" src="/public/assets/img/products/7.jpg" alt="" width="60" /></a>
                    <div class="flex-1">
              ...
              <div class="row gx-x1 mx-0 align-items-center border-bottom border-200">
                <div class="col-8 py-3 px-x1">
                  <div class="d-flex align-items-center"><a href="app/e-commerce/product/product-details.html"><img class="img-fluid rounded-1 me-3 d-none d-md-block" src="/public/assets/img/products/8.jpg" alt="" width="60" /></a>
                    <div class="flex-1">
            ...
            <div class="col-lg-6">
              <div class="card h-100">
                ...
                <div class="card-body bg-body-tertiary">
                  ...
                  <p class="fs-10 text-600">Once you start your trial, you will have 30 days to use Falcon Premium for free. After 30 days you’ll be charged based on your selected plan.</p>
                  ...
                  <table class="table table-borderless fs-10 mb-0">
                    <tr class="border-bottom">
                      <th class="ps-0 pt-0">Apple MacBook Pro 15" x 1
                        <div class="text-400 fw-normal fs-11">Z0V20008N: 2.9GHz 6-core 8th-Gen Intel Core i9, 32GB RAM</div>
                      </th>
                      <th class="pe-0 text-end pt-0">$1345</th>
                    </tr>
                    <tr class="border-bottom">
                      <th class="ps-0">Apple iMac Pro x 1
                        <div class="text-400 fw-normal fs-11">27-inch with Retina 5K Display, 3.0GHz 10-core Intel Xeon W, 1TB</div>
                      </th>
                  ...
                  <div class="table-responsive scrollbar">
                    <table class="table table-dashboard mb-0 table-borderless fs-10 border-200">
                      ...
                      <tbody>
                        <tr class="border-bottom border-200">
                          <td>
                            <div class="d-flex align-items-center position-relative"><img class="rounded-1 border border-200" src="/public/assets/img/ecommerce/1.jpg" width="60" alt="" />
                              <div class="flex-1 ms-3">
                        ...
                        <tr class="border-bottom border-200">
                          <td>
                            <div class="d-flex align-items-center position-relative"><img class="rounded-1 border border-200" src="/public/assets/img/ecommerce/2.jpg" width="60" alt="" />
                              <div class="flex-1 ms-3">
                        ...
                        <tr class="border-bottom border-200">
                          <td>
                            <div class="d-flex align-items-center position-relative"><img class="rounded-1 border border-200" src="/public/assets/img/ecommerce/3.jpg" width="60" alt="" />
                              <div class="flex-1 ms-3">
                        ...
                        <tr class="border-bottom border-200">
                          <td>
                            <div class="d-flex align-items-center position-relative"><img class="rounded-1 border border-200" src="/public/assets/img/ecommerce/4.jpg" width="60" alt="" />
                              <div class="flex-1 ms-3">
                        ...
                        <tr class="border-bottom border-200">
                          <td>
                            <div class="d-flex align-items-center position-relative"><img class="rounded-1 border border-200" src="/public/assets/img/ecommerce/5.jpg" width="60" alt="" />
                              <div class="flex-1 ms-3">
                        ...
                        <tr class="border-bottom border-200">
                          <td>
                            <div class="d-flex align-items-center position-relative"><img class="rounded-1 border border-200" src="/public/assets/img/ecommerce/6.jpg" width="60" alt="" />
                              <div class="flex-1 ms-3">
                        ...
                        <tr>
                          <td>
                            <div class="d-flex align-items-center position-relative"><img class="rounded-1 border border-200" src="/public/assets/img/ecommerce/7.jpg" width="60" alt="" />
                              <div class="flex-1 ms-3">
          ...
          <div class="d-flex mb-4 mt-6"><span class="fa-stack me-2 ms-n1"><i class="bi bi-circle-fill fa-stack-2x text-300"></i><i class="fa-inverse fa-stack-1x text-primary fas fa-user-friends" data-fa-transform="shrink-4"></i></span>
            <div class="col">
                  ...
                  <a class="border-bottom-0 notification rounded-0 border-x-0 border-300" href="#!">
                    <div class="notification-avatar">
                      <div class="avatar avatar-xl me-3">
                        <img class="rounded-circle" src="/public/assets/img/team/1.jpg" alt="" />
              ...
              <div class="card mb-3">
                ...
                <div class="card-body fs-10 pb-0">
                  <div class="row">
                    ...
                    <div class="col-sm-6 col-md-4 mb-3">
                      <div class="d-flex position-relative align-items-center mb-2"><img class="d-flex align-self-center me-2 rounded-3" src="/public/assets/img/logos/mailbluster.png" alt="" width="50" />
                        <div class="flex-1">
                    ...
                    <div class="col-sm-6 col-md-4 mb-3">
                      <div class="d-flex position-relative align-items-center mb-2"><img class="d-flex align-self-center me-2 rounded-3" src="/public/assets/img/logos/digitalocean.png" alt="" width="50" />
                        <div class="flex-1">
                    ...
                    <div class="col-sm-6 col-md-4 mb-3">
                      <div class="d-flex position-relative align-items-center mb-2"><img class="d-flex align-self-center me-2 rounded-3" src="/public/assets/img/logos/nvidia.png" alt="" width="50" />
                        <div class="flex-1">
                    ...
                    <div class="col-sm-6 col-md-4 mb-3">
                      <div class="d-flex position-relative align-items-center mb-2"><img class="d-flex align-self-center me-2 rounded-3" src="/public/assets/img/logos/hp.png" alt="" width="50" />
                        <div class="flex-1">
                    ...
                    <div class="col-sm-6 col-md-4 mb-3">
                      <div class="d-flex position-relative align-items-center mb-2"><img class="d-flex align-self-center me-2 rounded-3" src="/public/assets/img/logos/spotify.png" alt="" width="50" />
                        <div class="flex-1">
                ...
                <div class="card-body bg-body-tertiary px-1 py-0">
                  <div class="row g-0 text-center fs-10">
                    <div class="col-6 col-md-4">
                      <div class="bg-white dark__bg-1100 p-3 h-100"><a href="pages/user/profile.html"><img class="img-thumbnail img-fluid rounded-circle mb-3 shadow-sm" src="/public/assets/img/team/1.jpg" alt="" width="100" /></a>
                    ...
                    <div class="col-6 col-md-4">
                      <div class="bg-white dark__bg-1100 p-3 h-100"><a href="pages/user/profile.html"><img class="img-thumbnail img-fluid rounded-circle mb-3 shadow-sm" src="/public/assets/img/team/2.jpg" alt="" width="100" /></a>
                    ...
                    <div class="col-6 col-md-4">
                      <div class="bg-white dark__bg-1100 p-3 h-100"><a href="pages/user/profile.html"><img class="img-thumbnail img-fluid rounded-circle mb-3 shadow-sm" src="/public/assets/img/team/3.jpg" alt="" width="100" /></a>
                    ...
                    <div class="col-6 col-md-4">
                      <div class="bg-white dark__bg-1100 p-3 h-100"><a href="pages/user/profile.html"><img class="img-thumbnail img-fluid rounded-circle mb-3 shadow-sm" src="/public/assets/img/team/4.jpg" alt="" width="100" /></a>
                    ...
                    <div class="col-6 col-md-4">
                      <div class="bg-white dark__bg-1100 p-3 h-100"><a href="pages/user/profile.html"><img class="img-thumbnail img-fluid rounded-circle mb-3 shadow-sm" src="/public/assets/img/team/5.jpg" alt="" width="100" /></a>
                    ...
                    <div class="col-6 col-md-4">
                      <div class="bg-white dark__bg-1100 p-3 h-100"><a href="pages/user/profile.html"><img class="img-thumbnail img-fluid rounded-circle mb-3 shadow-sm" src="/public/assets/img/team/6.jpg" alt="" width="100" /></a>
              ...
              <div class="card h-100">
                <div class="card-body text-center py-5">
                  <div class="row justify-content-center">
                    <div class="col-7 col-md-5"><img class="img-fluid" src="/public/assets/img/icons/spot-illustrations/41.png" alt="" style="width:58%;" /></div>
                  </div>
                  ...
                  <div class="row justify-content-center">
                    <div class="col-11 col-sm-10">
                      ...
                      <div class="row gx-2 my-4">
                        <div class="col-12">
                          <button class="btn btn-falcon-default d-block w-100 mb-2"><img src="/public/assets/img/logos/gmail.png" width="20" alt="" /><span class="fw-medium ms-2">Invite from Gmail</span></button>
                        </div>
                        <div class="col-12">
                  ...
                  <div class="card h-100">
                    <div class="card-header bg-body-tertiary">
                      <div class="row justify-content-between">
                        <div class="col">
                          <div class="d-flex">
                            <div class="avatar avatar-2xl">
                              <img class="rounded-circle" src="/public/assets/img/team/8.jpg" alt="" />
                        ...
                        <div class="col-auto">
                          <div class="dropdown font-sans-serif btn-reveal-trigger">
                            <button class="btn btn-link text-600 btn-sm dropdown-toggle dropdown-caret-none btn-reveal" type="button" id="post-video-action" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><span class="bi bi-three-dots fs-10"></span></button>
                    ...
                    <div class="card-footer bg-body-tertiary pt-0">
                      <div class="row g-0 fw-semi-bold text-center py-2 fs-10">
                        <div class="col-auto"><a class="rounded-2 d-flex align-items-center me-3 text-700" href="#!"><img src="/public/assets/img/icons/spot-illustrations/like-inactive.png" width="20" alt="" /><span class="ms-1">Like</span></a></div>
                        <div class="col-auto"><a class="rounded-2 d-flex align-items-center me-3 text-700" href="#!"><img src="/public/assets/img/icons/spot-illustrations/comment-inactive.png" width="20" alt="" /><span class="ms-1">Comment</span></a></div>
                        <div class="col-auto d-flex align-items-center"><a class="rounded-2 text-700 d-flex align-items-center" href="#!"><img src="/public/assets/img/icons/spot-illustrations/share-inactive.png" width="20" alt="" /><span class="ms-1">Share</span></a></div>
                      </div>
                  ...
                  <div class="card h-100">
                    <div class="card-header bg-body-tertiary">
                      <div class="row justify-content-between">
                        ...
                        <div class="col-auto">
                          <div class="dropdown font-sans-serif btn-reveal-trigger">
                            <button class="btn btn-link text-600 btn-sm dropdown-toggle dropdown-caret-none btn-reveal" type="button" id="post-album-action" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><span class="bi bi-three-dots fs-10"></span></button>
                    ...
                    <div class="card-body overflow-hidden">
                      ...
                      <div class="row mx-n1">
                        <div class="col-6 p-1"><a href="/public/assets/img/generic/4.jpg" data-gallery="gallery-1"><img class="img-fluid rounded" src="/public/assets/img/generic/4.jpg" alt="" /></a></div>
                        <div class="col-6 p-1"><a href="/public/assets/img/generic/5.jpg" data-gallery="gallery-1"><img class="img-fluid rounded" src="/public/assets/img/generic/5.jpg" alt="" /></a></div>
                        <div class="col-4 p-1"><a href="/public/assets/img/gallery/4.jpg" data-gallery="gallery-1"><img class="img-fluid rounded" src="/public/assets/img/gallery/4.jpg" alt="" /></a></div>
                        <div class="col-4 p-1"><a href="/public/assets/img/gallery/5.jpg" data-gallery="gallery-1"><img class="img-fluid rounded" src="/public/assets/img/gallery/5.jpg" alt="" /></a></div>
                        <div class="col-4 p-1"><a href="/public/assets/img/gallery/3.jpg" data-gallery="gallery-1"><img class="img-fluid rounded" src="/public/assets/img/gallery/3.jpg" alt="" /></a></div>
                      </div>
                    </div>
                    <div class="card-footer bg-body-tertiary pt-0">
                      ...
                      <div class="row g-0 fw-semi-bold text-center py-2 fs-10">
                        <div class="col-auto"><a class="rounded-2 d-flex align-items-center me-3" href="#!"><img src="/public/assets/img/icons/spot-illustrations/like-active.png" width="20" alt="" /><span class="ms-1">Like</span></a></div>
                        <div class="col-auto"><a class="rounded-2 d-flex align-items-center me-3" href="#!"><img src="/public/assets/img/icons/spot-illustrations/comment-active.png" width="20" alt="" /><span class="ms-1">Comment</span></a></div>
                        <div class="col-auto d-flex align-items-center"><a class="rounded-2 text-700 d-flex align-items-center" href="#!"><img src="/public/assets/img/icons/spot-illustrations/share-inactive.png" width="20" alt="" /><span class="ms-1">Share</span></a></div>
                      </div>
                      <form class="d-flex align-items-center border-top border-200 pt-3">
                        <div class="avatar avatar-xl">
            ...
            <div class="col-lg-4 ps-lg-2 mb-3">
                ...
                <div class="card-body">
                  <div class="d-flex">
                    ...
                    <div class="flex-1 ms-2">
                      ...
                      <button class="btn btn-tertiary btn-sm py-0 mt-1 border" type="button"><span class="fas fa-user-plus" data-fa-transform="shrink-5 left-2"></span><span class="fs-10">Follow</span></button>
                      <div class="border-bottom border-dashed my-3"></div>
                    </div>
                  </div>
                  <div class="d-flex">
                  ...
                  <div class="d-flex">
                    <div class="avatar avatar-3xl">
                      <img class="rounded-circle" src="/public/assets/img/team/15.jpg" alt="" />
              ...
              <div class="card">
                <div class="card-header d-flex flex-between-center bg-body-tertiary py-2">
                  <h6 class="mb-0">Active Users</h6>
                  <div class="dropdown font-sans-serif btn-reveal-trigger">
                    <button class="btn btn-link text-600 btn-sm dropdown-toggle dropdown-caret-none btn-reveal" type="button" id="dropdown-active-user" data-bs-toggle="dropdown" data-boundary="viewport" aria-haspopup="true" aria-expanded="false"><span class="bi bi-three-dots fs-11"></span></button>
          ...
          <div class="card cover-image mb-3"><img class="card-img-top" src="/public/assets/img/generic/13.jpg" alt="" />
          ...
          <div class="d-flex mb-4 mt-6"><span class="fa-stack me-2 ms-n1"><i class="bi bi-circle-fill fa-stack-2x text-300"></i><i class="fa-inverse fa-stack-1x text-primary fas fa-exclamation-circle"></i></span>
            <div class="col">
          ...
          <div class="d-flex mb-4 mt-6"><span class="fa-stack me-2 ms-n1"><i class="bi bi-circle-fill fa-stack-2x text-300"></i><i class="fa-inverse fa-stack-1x text-primary bi bi-file-text" data-fa-transform="shrink-2"></i></span>
            <div class="col">
              ...
              <div class="row g-0 h-100 align-items-stretch">
                <div class="col-lg-12 mb-3">
                  <div class="card h-100">
                    ...
                    <div class="card-body bg-body-tertiary pb-0"><a class="mb-4 d-block d-flex align-items-center" href="#experience-form" data-bs-toggle="collapse" aria-expanded="true" aria-controls="experience-form"><span class="circle-dashed"><span class="bi bi-plus"></span></span><span class="ms-3">Add new experience</span></a>
                  ...
                  <div class="card h-100">
                    ...
                    <div class="card-body bg-body-tertiary pb-0">
                      <form data-wizard-form="2">
                        <div class="mb-3">
                          <div class="row" data-dropzone="data-dropzone" data-options='{"maxFiles":1,"data":[{"name":"avatar.png","size":"54kb","url":"/public/assets/img/team"}]}'>
                            <div class="fallback">
                ...
                <div class="card-body p-0">
                  <form>
                    ...
                    <div class="d-flex align-items-center ps-x1 border border-200">
                      <label class="text-nowrap mb-0 me-2" for="hash-tags"><span class="bi bi-plus me-1 fs-11"></span><span class="fw-medium fs-10">Add hashtag</span></label>
                    ...
                    <div class="row g-0 justify-content-between mt-3 px-x1 pb-3">
                      <div class="col">
                        <button class="btn btn-tertiary btn-sm rounded-pill shadow-none d-inline-flex align-items-center fs-10 mb-0 me-1" type="button"><img class="cursor-pointer" src="/public/assets/img/icons/spot-illustrations/image.svg" width="17" alt="" /><span class="ms-2 d-none d-md-inline-block">Image</span></button>
                        <button class="btn btn-tertiary btn-sm rounded-pill shadow-none d-inline-flex align-items-center fs-10 me-1" type="button"><img class="cursor-pointer" src="/public/assets/img/icons/spot-illustrations/calendar.svg" width="17" alt="" /><span class="ms-2 d-none d-md-inline-block">Event</span></button>
                        <button class="btn btn-tertiary btn-sm rounded-pill shadow-none d-inline-flex align-items-center fs-10 me-1" type="button"><img class="cursor-pointer" src="/public/assets/img/icons/spot-illustrations/location.svg" width="17" alt="" /><span class="ms-2 d-none d-md-inline-block text-nowrap">Check in</span></button>
                      </div>
                      <div class="col-auto">
          ...
          <form class="card mb-3">
            ...
            <div class="card-body p-0">
              ...
              <div class="bg-body-tertiary px-x1 py-3">
                <div class="d-inline-flex flex-column">
                  <div class="border px-2 rounded-3 d-flex flex-between-center bg-white dark__bg-1000 my-1 fs-10"><span class="fs-8 far fa-image"></span><span class="ms-2">winter.jpg (873kb)</span><a class="text-300 p-1 ms-6" href="#!" data-bs-toggle="tooltip" data-bs-placement="right" title="Detach"><span class="bi bi-x-lg"></span></a></div>
                  <div class="border px-2 rounded-3 d-flex flex-between-center bg-white dark__bg-1000 my-1 fs-10"><span class="fs-8 far fa-file-archive"></span><span class="ms-2">coffee.zip (342kb)</span><a class="text-300 p-1 ms-6" href="#!" data-bs-toggle="tooltip" data-bs-placement="right" title="Detach"><span class="bi bi-x-lg"></span></a></div>
                </div>
              </div>
            </div>
            <div class="card-footer border-top border-200 d-flex flex-between-center">
              ...
              <div class="d-flex align-items-center">
                ...
                <button class="btn btn-tertiary btn-sm" type="button" data-bs-toggle="tooltip" data-bs-placement="top" title="Delete"><span class="fas fa-trash"></span></button>
              </div>
            </div>
          </form>
          <div class="card mb-3">
            ...
            <div class="card-body bg-body-tertiary">
              <form class="dropzone dropzone-multiple p-0" id="my-awesome-dropzone" data-dropzone="data-dropzone" action="#!">
                ...
                <div class="dz-message" data-dz-message="data-dz-message"> <img class="me-2" src="/public/assets/img/icons/cloud-upload.svg" width="25" alt="" />Drop your files here</div>
                <div class="dz-preview dz-preview-multiple m-0 d-flex flex-column">
                  <div class="d-flex media align-items-center mb-3 pb-3 border-bottom btn-reveal-trigger"><img class="dz-image" src="/public/assets/img/generic/image-file-2.png" alt="..." data-dz-thumbnail="data-dz-thumbnail" />
                    <div class="flex-1 d-flex flex-between-center">
                      ...
                      <div class="dropdown font-sans-serif">
                        <button class="btn btn-link text-600 btn-sm dropdown-toggle btn-reveal dropdown-caret-none" type="button" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><span class="bi bi-three-dots"></span></button>
          ...
          <div class="d-flex mb-4 mt-6"><span class="fa-stack me-2 ms-n1"><i class="bi bi-circle-fill fa-stack-2x text-300"></i><i class="fa-inverse fa-stack-1x text-primary fas fa-folder-plus" data-fa-transform="shrink-2"></i></span>
            <div class="col">
          ...
          <div class="row g-3 mb-3">
            <div class="col-xxl-8 d-flex flex-column align-items-stretched">
              <div class="card mb-3">
                <div class="bg-holder d-none d-lg-block bg-card" style="background-image:url(/public/assets/img/icons/spot-illustrations/corner-4.png);">
                </div>
                <!--/.bg-holder-->
                        ...
                        <div class="dropdown-menu py-3" aria-labelledby="change-plan" style="min-width: 15rem;">
                          <div class="dropdown-item px-3 py-2"><span class="d-flex justify-content-between fs-10 text-black"><span class="fw-semi-bold">Standard License</span><span>$59.00</span></span>
                            <ul class="list-unstyled ps-1 my-2 fs-10">
                              <li> <span class="bi bi-circle-fill" data-fa-transform="shrink-11"></span><span class="ms-1">Use for a single product</span></li>
                              <li><span class="bi bi-circle-fill" data-fa-transform="shrink-11"></span><span class="ms-1">Non-paying users only</span></li>
                            </ul>
                          ...
                          <div class="dropdown-item px-3 py-2"><span class="d-flex justify-content-between fs-10 text-black"><span class="fw-semi-bold">Extended License</span><span>$99.00</span></span>
                            <ul class="list-unstyled ps-1 my-2 fs-10">
                              <li> <span class="bi bi-circle-fill" data-fa-transform="shrink-11"></span><span class="ms-1">Unlimited websites</span></li>
                              <li> <span class="bi bi-circle-fill" data-fa-transform="shrink-11"></span><span class="ms-1">Paying users allowed</span></li>
                            </ul>
            ...
            <div class="col-xl-5 col-xxl-4">
              <div class="row g-3">
                <div class="col-lg-4 col-xl-12">
                  <div class="card h-100">
                    <div class="card-header d-flex flex-between-center pb-0">
                      ...
                      <div class="dropdown font-sans-serif btn-reveal-trigger">
                        <button class="btn btn-link text-600 btn-sm dropdown-toggle dropdown-caret-none btn-reveal" type="button" id="dropdown-weather-update" data-bs-toggle="dropdown" data-boundary="viewport" aria-haspopup="true" aria-expanded="false"><span class="bi bi-three-dots fs-11"></span></button>
                    ...
                    <div class="card-body pt-2">
                      <div class="row g-0 h-100 align-items-center">
                        <div class="col">
                          <div class="d-flex align-items-center"><img class="me-3" src="/public/assets/img/icons/weather-icon.png" alt="" height="60" />
                            <div>
                ...
                <div class="col-lg-3 col-xl-12">
                  <div class="card h-100">
                    <div class="bg-holder d-none d-xl-block bg-card" style="background-image:url(/public/assets/img/icons/spot-illustrations/corner-4.png);opacity: 0.7;">
                    </div>
                    <!--/.bg-holder-->
            ...
            <div class="col-xl-7 col-xxl-8">
              <div class="card h-100">
                <div class="card-header bg-body-tertiary d-flex flex-between-center">
                  ...
                  <div class="dropdown font-sans-serif btn-reveal-trigger">
                    <button class="btn btn-link text-600 btn-sm dropdown-toggle dropdown-caret-none btn-reveal" type="button" data-bs-toggle="dropdown" data-boundary="viewport" aria-haspopup="true" aria-expanded="false"><span class="bi bi-three-dots fs-10"></span></button>
                    ...
                    <div class="col-md-7">
                      <div class="p-x1">
                        <div class="d-flex justify-content-between">
                          ...
                          <button class="btn btn-sm text-primary border order-md-0 shadow-none" type="button" data-bs-toggle="modal" data-bs-target="#addEventModal"> <span class="bi bi-plus me-2"></span>New Schedule</button>
                        </div>
                      </div>
          ...
          <div class="row g-3 mb-3">
            <div class="col-lg-6">
              <div class="card h-100">
                <div class="card-body p-4 p-sm-5">
                  <div class="text-center"><img class="d-block mx-auto mb-4" src="/public/assets/img/icons/spot-illustrations/45.png" alt="shield" width="100" />
                    <h4>See you again!</h4>
              ...
              <div class="card">
                <div class="card-body p-4 p-sm-5">
                  <div class="text-center"><img class="d-block mx-auto mb-4" src="/public/assets/img/icons/spot-illustrations/16.png" alt="Email" width="100" />
                    ...
                    <p>An email has been sent to <strong>xyz@abc.com</strong>. Please click on the included link to reset <span class="white-space-nowrap">your password.</span>
    ...
    <script src="/public/assets/data/world.js"></script>
    <script src="/public/assets/vendors/plyr/plyr.polyfilled.min.js"> </script>
    <script src="/public/assets/vendors/countup/countUp.umd.js"></script>
    <script src="/public/assets/vendors/chart/chart.min.js"></script>
    <script src="/public/assets/vendors/dropzone/dropzone.min.js"></script>
    <script src="/public/assets/vendors/leaflet/leaflet.js"></script>
    <script src="/public/assets/vendors/leaflet.markercluster/leaflet.markercluster.js"></script>
    <script src="/public/assets/vendors/leaflet.tilelayer.colorfilter/leaflet-tilelayer-colorfilter.min.js"></script>
    ...
    <script src="/public/assets/vendors/fullcalendar/main.min.js"></script>
