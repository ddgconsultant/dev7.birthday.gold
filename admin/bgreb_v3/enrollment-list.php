...
$buttonContainerClass = $scheduleresult['allow_enrollment'] ? 
    ...
    'border border-2 border-secondary rounded p-2';
           ...
           <div class="d-block d-md-none fs-10">
            ...
            $enrollingbutton='<div class="my-1"><a target="userregistration" href="' . $linkbase . $user['user_id'] . '" class="btn btn-sm ' . $buttonClass . '">Start Enrolling</a></div>';
...
<h2 class="mb-0">Pending Enrollments</h2>
