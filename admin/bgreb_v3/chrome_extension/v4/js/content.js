...
function updateDatabase(aid, userId, action, companyId, usercompanyId) {
  ...
  const url = `https://${domain}/admin/bgreb_v3/bgr_actions.php?aid=${encodeURIComponent(aid)}&uid=${encodeURIComponent(userId)}&act=${encodeURIComponent(action)}&cid=${encodeURIComponent(companyId)}&ucid=${encodeURIComponent(usercompanyId)}&message=done&version=${encodeURIComponent(version)}&`;
