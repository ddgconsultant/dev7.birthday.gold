...
<div class="container">
    ...
    <div class="btn-group">
        ...
        <button type="button" class="btn btn-outline" onclick="location.href='<?php echo $_SERVER['PHP_SELF']; ?>?cid=<?php echo $company_id; ?>&newversion=<?php echo ($versionnumber + 1); ?>&section=formfieldedit'">
            <i class="bi bi-plus-circle me-2"></i> New Version
        </button>
        <button type="button" class="btn btn-outline" onclick="location.href='<?php echo $_SERVER['PHP_SELF']; ?>?buildout=<?php echo $company_id; ?>&cid=<?php echo $company_id; ?>&section=formfieldedit'">
