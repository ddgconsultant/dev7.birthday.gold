...
if ($iframeAllowed) {
    ...
    echo '<div>'.print_r($headers,1).'</div>';
    echo '<iframe src="' . htmlspecialchars($iframeUrl) . '" ' . $iframestyletagnoscale . '></iframe>';
} else {
