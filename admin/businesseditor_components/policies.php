...
?>
    ...
    <?php
    // Fetch policies from bg_company_attributes
    ...
    // Display policy card
    echo '<div class="card">
    <h2 class="card-header fw-bold " id="heading' . $company_id . '">
        <div class="card ' . $headerColor . ' bg-opacity-50 ' . $linkColor . ' fw-bold" >
    ...
    // Add window opening script
    echo '
    <script>
        function openWindow(url) {
            window.open(url, "policyWindow", "width=1000,height=800");
        }
    </script>';
    ?>